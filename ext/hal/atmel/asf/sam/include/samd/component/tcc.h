...
#define TCC_CTRLA_MASK              _U(0x0F007F63) /**< \brief (TCC_CTRLA) MASK Register */
...
#define   TCC_CTRLBCLR_CMD_UPDATE_Val     _U(0x3)   /**< \brief (TCC_CTRLBCLR) Force update of double buffered registers */
...
#define   TCC_CTRLBSET_CMD_UPDATE_Val     _U(0x3)   /**< \brief (TCC_CTRLBSET) Force update of double buffered registers */
...
#define TCC_SYNCBUSY_PATTB          (_U(0x1) << TCC_SYNCBUSY_PATTB_Pos)
#define TCC_SYNCBUSY_WAVEB_Pos      17           /**< \brief (TCC_SYNCBUSY) Wave Buffer Busy */
#define TCC_SYNCBUSY_WAVEB          (_U(0x1) << TCC_SYNCBUSY_WAVEB_Pos)
#define TCC_SYNCBUSY_PERB_Pos       18           /**< \brief (TCC_SYNCBUSY) Period Buffer Busy */
#define TCC_SYNCBUSY_PERB           (_U(0x1) << TCC_SYNCBUSY_PERB_Pos)
...
#define TCC_SYNCBUSY_CCB_Msk        (_U(0xF) << TCC_SYNCBUSY_CCB_Pos)
#define TCC_SYNCBUSY_CCB(value)     (TCC_SYNCBUSY_CCB_Msk & ((value) << TCC_SYNCBUSY_CCB_Pos))
#define TCC_SYNCBUSY_MASK           _U(0x007F0FFF) /**< \brief (TCC_SYNCBUSY) MASK Register */
...
#define   TCC_FCTRLA_BLANK_NONE_Val       _U(0x0)   /**< \brief (TCC_FCTRLA) No blanking applied */
...
#define TCC_FCTRLA_MASK             _U(0x0FFF7FFB) /**< \brief (TCC_FCTRLA) MASK Register */
...
#define   TCC_FCTRLB_BLANK_NONE_Val       _U(0x0)   /**< \brief (TCC_FCTRLB) No blanking applied */
...
#define TCC_FCTRLB_MASK             _U(0x0FFF7FFB) /**< \brief (TCC_FCTRLB) MASK Register */
...
#define TCC_INTENCLR_MASK           _U(0x000FF80F) /**< \brief (TCC_INTENCLR) MASK Register */
...
#define TCC_INTENSET_MASK           _U(0x000FF80F) /**< \brief (TCC_INTENSET) MASK Register */
...
#define TCC_INTFLAG_MASK            _U(0x000FF80F) /**< \brief (TCC_INTFLAG) MASK Register */
...
#define TCC_STATUS_PATTBV           (_U(0x1) << TCC_STATUS_PATTBV_Pos)
#define TCC_STATUS_WAVEBV_Pos       6            /**< \brief (TCC_STATUS) Wave Buffer Valid */
#define TCC_STATUS_WAVEBV           (_U(0x1) << TCC_STATUS_WAVEBV_Pos)
#define TCC_STATUS_PERBV_Pos        7            /**< \brief (TCC_STATUS) Period Buffer Valid */
#define TCC_STATUS_PERBV            (_U(0x1) << TCC_STATUS_PERBV_Pos)
...
#define TCC_STATUS_CCBV_Msk         (_U(0xF) << TCC_STATUS_CCBV_Pos)
...
#define TCC_STATUS_MASK             _U(0x0F0FFFFB) /**< \brief (TCC_STATUS) MASK Register */
...
#define TCC_PER_DITH4_DITHERCY_Msk  (_U(0xF) << TCC_PER_DITH4_DITHERCY_Pos)
...
#define TCC_PER_DITH5_DITHERCY_Msk  (_U(0x1F) << TCC_PER_DITH5_DITHERCY_Pos)
...
#define TCC_PER_DITH6_DITHERCY_Msk  (_U(0x3F) << TCC_PER_DITH6_DITHERCY_Pos)
...
#define TCC_CC_DITH4_DITHERCY_Msk   (_U(0xF) << TCC_CC_DITH4_DITHERCY_Pos)
...
#define TCC_CC_DITH5_DITHERCY_Msk   (_U(0x1F) << TCC_CC_DITH5_DITHERCY_Pos)
...
#define TCC_CC_DITH6_DITHERCY_Msk   (_U(0x3F) << TCC_CC_DITH6_DITHERCY_Pos)
...
#define TCC_PATTB_RESETVALUE        _U(0x0000)   /**< \brief (TCC_PATTB reset_value) Pattern Buffer */
...
#define TCC_PATTB_PGEB_Msk          (_U(0xFF) << TCC_PATTB_PGEB_Pos)
...
#define TCC_PATTB_PGVB_Msk          (_U(0xFF) << TCC_PATTB_PGVB_Pos)
#define TCC_PATTB_PGVB(value)       (TCC_PATTB_PGVB_Msk & ((value) << TCC_PATTB_PGVB_Pos))
#define TCC_PATTB_MASK              _U(0xFFFF)   /**< \brief (TCC_PATTB) MASK Register */
...
#define TCC_WAVEB_RESETVALUE        _U(0x00000000) /**< \brief (TCC_WAVEB reset_value) Waveform Control Buffer */

#define TCC_WAVEB_WAVEGENB_Pos      0            /**< \brief (TCC_WAVEB) Waveform Generation Buffer */
#define TCC_WAVEB_WAVEGENB_Msk      (_U(0x7) << TCC_WAVEB_WAVEGENB_Pos)
#define TCC_WAVEB_WAVEGENB(value)   (TCC_WAVEB_WAVEGENB_Msk & ((value) << TCC_WAVEB_WAVEGENB_Pos))
#define   TCC_WAVEB_WAVEGENB_NFRQ_Val     _U(0x0)   /**< \brief (TCC_WAVEB) Normal frequency */
#define   TCC_WAVEB_WAVEGENB_MFRQ_Val     _U(0x1)   /**< \brief (TCC_WAVEB) Match frequency */
#define   TCC_WAVEB_WAVEGENB_NPWM_Val     _U(0x2)   /**< \brief (TCC_WAVEB) Normal PWM */
#define   TCC_WAVEB_WAVEGENB_DSCRITICAL_Val _U(0x4)   /**< \brief (TCC_WAVEB) Dual-slope critical */
#define   TCC_WAVEB_WAVEGENB_DSBOTTOM_Val _U(0x5)   /**< \brief (TCC_WAVEB) Dual-slope with interrupt/event condition when COUNT reaches ZERO */
#define   TCC_WAVEB_WAVEGENB_DSBOTH_Val   _U(0x6)   /**< \brief (TCC_WAVEB) Dual-slope with interrupt/event condition when COUNT reaches ZERO or TOP */
#define   TCC_WAVEB_WAVEGENB_DSTOP_Val    _U(0x7)   /**< \brief (TCC_WAVEB) Dual-slope with interrupt/event condition when COUNT reaches TOP */
...
#define TCC_WAVEB_RAMPB_Msk         (_U(0x3) << TCC_WAVEB_RAMPB_Pos)
#define TCC_WAVEB_RAMPB(value)      (TCC_WAVEB_RAMPB_Msk & ((value) << TCC_WAVEB_RAMPB_Pos))
#define   TCC_WAVEB_RAMPB_RAMP1_Val       _U(0x0)   /**< \brief (TCC_WAVEB) RAMP1 operation */
#define   TCC_WAVEB_RAMPB_RAMP2A_Val      _U(0x1)   /**< \brief (TCC_WAVEB) Alternative RAMP2 operation */
#define   TCC_WAVEB_RAMPB_RAMP2_Val       _U(0x2)   /**< \brief (TCC_WAVEB) RAMP2 operation */
...
#define TCC_WAVEB_CIPERENB          (_U(0x1) << TCC_WAVEB_CIPERENB_Pos)
...
#define TCC_WAVEB_CICCENB_Msk       (_U(0xF) << TCC_WAVEB_CICCENB_Pos)
...
#define TCC_WAVEB_POLB_Msk          (_U(0xF) << TCC_WAVEB_POLB_Pos)
...
#define TCC_WAVEB_SWAPB_Msk         (_U(0xF) << TCC_WAVEB_SWAPB_Pos)
#define TCC_WAVEB_SWAPB(value)      (TCC_WAVEB_SWAPB_Msk & ((value) << TCC_WAVEB_SWAPB_Pos))
#define TCC_WAVEB_MASK              _U(0x0F0F0FB7) /**< \brief (TCC_WAVEB) MASK Register */
...
#define TCC_PERB_RESETVALUE         _U(0xFFFFFFFF) /**< \brief (TCC_PERB reset_value) Period Buffer */

// DITH4 mode
#define TCC_PERB_DITH4_DITHERCYB_Pos 0            /**< \brief (TCC_PERB_DITH4) Dithering Buffer Cycle Number */
#define TCC_PERB_DITH4_DITHERCYB_Msk (_U(0xF) << TCC_PERB_DITH4_DITHERCYB_Pos)
...
#define TCC_PERB_DITH4_PERB_Msk     (_U(0xFFFFF) << TCC_PERB_DITH4_PERB_Pos)
#define TCC_PERB_DITH4_PERB(value)  (TCC_PERB_DITH4_PERB_Msk & ((value) << TCC_PERB_DITH4_PERB_Pos))
#define TCC_PERB_DITH4_MASK         _U(0x00FFFFFF) /**< \brief (TCC_PERB_DITH4) MASK Register */

// DITH5 mode
#define TCC_PERB_DITH5_DITHERCYB_Pos 0            /**< \brief (TCC_PERB_DITH5) Dithering Buffer Cycle Number */
#define TCC_PERB_DITH5_DITHERCYB_Msk (_U(0x1F) << TCC_PERB_DITH5_DITHERCYB_Pos)
...
#define TCC_PERB_DITH5_PERB_Msk     (_U(0x7FFFF) << TCC_PERB_DITH5_PERB_Pos)
#define TCC_PERB_DITH5_PERB(value)  (TCC_PERB_DITH5_PERB_Msk & ((value) << TCC_PERB_DITH5_PERB_Pos))
#define TCC_PERB_DITH5_MASK         _U(0x00FFFFFF) /**< \brief (TCC_PERB_DITH5) MASK Register */

// DITH6 mode
#define TCC_PERB_DITH6_DITHERCYB_Pos 0            /**< \brief (TCC_PERB_DITH6) Dithering Buffer Cycle Number */
#define TCC_PERB_DITH6_DITHERCYB_Msk (_U(0x3F) << TCC_PERB_DITH6_DITHERCYB_Pos)
...
#define TCC_PERB_DITH6_PERB_Msk     (_U(0x3FFFF) << TCC_PERB_DITH6_PERB_Pos)
#define TCC_PERB_DITH6_PERB(value)  (TCC_PERB_DITH6_PERB_Msk & ((value) << TCC_PERB_DITH6_PERB_Pos))
#define TCC_PERB_DITH6_MASK         _U(0x00FFFFFF) /**< \brief (TCC_PERB_DITH6) MASK Register */

#define TCC_PERB_PERB_Pos           0            /**< \brief (TCC_PERB) Period Buffer Value */
#define TCC_PERB_PERB_Msk           (_U(0xFFFFFF) << TCC_PERB_PERB_Pos)
#define TCC_PERB_PERB(value)        (TCC_PERB_PERB_Msk & ((value) << TCC_PERB_PERB_Pos))
#define TCC_PERB_MASK               _U(0x00FFFFFF) /**< \brief (TCC_PERB) MASK Register */
...
#define TCC_CCB_RESETVALUE          _U(0x00000000) /**< \brief (TCC_CCB reset_value) Compare and Capture Buffer */

// DITH4 mode
#define TCC_CCB_DITH4_DITHERCYB_Pos 0            /**< \brief (TCC_CCB_DITH4) Dithering Buffer Cycle Number */
#define TCC_CCB_DITH4_DITHERCYB_Msk (_U(0xF) << TCC_CCB_DITH4_DITHERCYB_Pos)
...
#define TCC_CCB_DITH4_CCB_Msk       (_U(0xFFFFF) << TCC_CCB_DITH4_CCB_Pos)
#define TCC_CCB_DITH4_CCB(value)    (TCC_CCB_DITH4_CCB_Msk & ((value) << TCC_CCB_DITH4_CCB_Pos))
#define TCC_CCB_DITH4_MASK          _U(0x00FFFFFF) /**< \brief (TCC_CCB_DITH4) MASK Register */

// DITH5 mode
#define TCC_CCB_DITH5_DITHERCYB_Pos 0            /**< \brief (TCC_CCB_DITH5) Dithering Buffer Cycle Number */
#define TCC_CCB_DITH5_DITHERCYB_Msk (_U(0x1F) << TCC_CCB_DITH5_DITHERCYB_Pos)
...
#define TCC_CCB_DITH5_CCB_Msk       (_U(0x7FFFF) << TCC_CCB_DITH5_CCB_Pos)
#define TCC_CCB_DITH5_CCB(value)    (TCC_CCB_DITH5_CCB_Msk & ((value) << TCC_CCB_DITH5_CCB_Pos))
#define TCC_CCB_DITH5_MASK          _U(0x00FFFFFF) /**< \brief (TCC_CCB_DITH5) MASK Register */

// DITH6 mode
#define TCC_CCB_DITH6_DITHERCYB_Pos 0            /**< \brief (TCC_CCB_DITH6) Dithering Buffer Cycle Number */
#define TCC_CCB_DITH6_DITHERCYB_Msk (_U(0x3F) << TCC_CCB_DITH6_DITHERCYB_Pos)
...
#define TCC_CCB_DITH6_CCB_Msk       (_U(0x3FFFF) << TCC_CCB_DITH6_CCB_Pos)
#define TCC_CCB_DITH6_CCB(value)    (TCC_CCB_DITH6_CCB_Msk & ((value) << TCC_CCB_DITH6_CCB_Pos))
#define TCC_CCB_DITH6_MASK          _U(0x00FFFFFF) /**< \brief (TCC_CCB_DITH6) MASK Register */

#define TCC_CCB_CCB_Pos             0            /**< \brief (TCC_CCB) Channel Compare/Capture Buffer Value */
#define TCC_CCB_CCB_Msk             (_U(0xFFFFFF) << TCC_CCB_CCB_Pos)
#define TCC_CCB_CCB(value)          (TCC_CCB_CCB_Msk & ((value) << TCC_CCB_CCB_Pos))
#define TCC_CCB_MASK                _U(0x00FFFFFF) /**< \brief (TCC_CCB) MASK Register */
