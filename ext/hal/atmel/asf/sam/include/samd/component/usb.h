...
#define USB_QOSCTRL_RESETVALUE      _U(0x05)     /**< \brief (USB_QOSCTRL reset_value) USB Quality Of Service */
...
#define   USB_QOSCTRL_CQOS_DISABLE_Val    _U(0x0)   /**< \brief (USB_QOSCTRL) Background (no sensitive operation) */
#define   USB_QOSCTRL_CQOS_LOW_Val        _U(0x1)   /**< \brief (USB_QOSCTRL) Sensitive Bandwidth */
#define   USB_QOSCTRL_CQOS_MEDIUM_Val     _U(0x2)   /**< \brief (USB_QOSCTRL) Sensitive Latency */
#define   USB_QOSCTRL_CQOS_HIGH_Val       _U(0x3)   /**< \brief (USB_QOSCTRL) Critical Latency */
...
#define   USB_QOSCTRL_DQOS_DISABLE_Val    _U(0x0)   /**< \brief (USB_QOSCTRL) Background (no sensitive operation) */
#define   USB_QOSCTRL_DQOS_LOW_Val        _U(0x1)   /**< \brief (USB_QOSCTRL) Sensitive Bandwidth */
#define   USB_QOSCTRL_DQOS_MEDIUM_Val     _U(0x2)   /**< \brief (USB_QOSCTRL) Sensitive Latency */
#define   USB_QOSCTRL_DQOS_HIGH_Val       _U(0x3)   /**< \brief (USB_QOSCTRL) Critical Latency */
...
#define USB_HOST_CTRLB_MASK         _U(0x0F6E)   /**< \brief (USB_HOST_CTRLB) MASK Register */
