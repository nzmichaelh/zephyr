...
#define PIN_PB12E_TC4_WO0              _L(44) /**< \brief TC4 signal: WO0 on PB12 mux E */
#define MUX_PB12E_TC4_WO0               _L(4)
#define PINMUX_PB12E_TC4_WO0       ((PIN_PB12E_TC4_WO0 << 16) | MUX_PB12E_TC4_WO0)
#define PORT_PB12E_TC4_WO0     (_UL(1) << 12)
...
#define PIN_PB13E_TC4_WO1              _L(45) /**< \brief TC4 signal: WO1 on PB13 mux E */
#define MUX_PB13E_TC4_WO1               _L(4)
#define PINMUX_PB13E_TC4_WO1       ((PIN_PB13E_TC4_WO1 << 16) | MUX_PB13E_TC4_WO1)
#define PORT_PB13E_TC4_WO1     (_UL(1) << 13)
...
#define PIN_PB22E_TC7_WO0              _L(54) /**< \brief TC7 signal: WO0 on PB22 mux E */
#define MUX_PB22E_TC7_WO0               _L(4)
...
#define PIN_PB01E_TC7_WO1              _L(33) /**< \brief TC7 signal: WO1 on PB01 mux E */
#define MUX_PB01E_TC7_WO1               _L(4)
#define PINMUX_PB01E_TC7_WO1       ((PIN_PB01E_TC7_WO1 << 16) | MUX_PB01E_TC7_WO1)
#define PORT_PB01E_TC7_WO1     (_UL(1) <<  1)
#define PIN_PB23E_TC7_WO1              _L(55) /**< \brief TC7 signal: WO1 on PB23 mux E */
#define MUX_PB23E_TC7_WO1               _L(4)
...
#define PIN_PB12G_I2S_FS1              _L(44) /**< \brief I2S signal: FS1 on PB12 mux G */
#define MUX_PB12G_I2S_FS1               _L(6)
#define PINMUX_PB12G_I2S_FS1       ((PIN_PB12G_I2S_FS1 << 16) | MUX_PB12G_I2S_FS1)
#define PORT_PB12G_I2S_FS1     (_UL(1) << 12)
...
#define PIN_PB17G_I2S_MCK0             _L(49) /**< \brief I2S signal: MCK0 on PB17 mux G */
#define MUX_PB17G_I2S_MCK0              _L(6)
#define PINMUX_PB17G_I2S_MCK0      ((PIN_PB17G_I2S_MCK0 << 16) | MUX_PB17G_I2S_MCK0)
#define PORT_PB17G_I2S_MCK0    (_UL(1) << 17)
...
#define PIN_PB16G_I2S_SD1              _L(48) /**< \brief I2S signal: SD1 on PB16 mux G */
#define MUX_PB16G_I2S_SD1               _L(6)
#define PINMUX_PB16G_I2S_SD1       ((PIN_PB16G_I2S_SD1 << 16) | MUX_PB16G_I2S_SD1)
#define PORT_PB16G_I2S_SD1     (_UL(1) << 16)
