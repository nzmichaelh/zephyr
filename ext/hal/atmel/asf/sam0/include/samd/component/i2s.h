...
#define I2S_CTRLA_RESETVALUE        __U(0x00)     /**< \brief (I2S_CTRLA reset_value) Control A */

#define I2S_CTRLA_SWRST_Pos         0            /**< \brief (I2S_CTRLA) Software Reset */
#define I2S_CTRLA_SWRST             (__U(0x1) << I2S_CTRLA_SWRST_Pos)
#define I2S_CTRLA_ENABLE_Pos        1            /**< \brief (I2S_CTRLA) Enable */
#define I2S_CTRLA_ENABLE            (__U(0x1) << I2S_CTRLA_ENABLE_Pos)
...
#define I2S_CTRLA_CKEN_Msk          (__U(0x3) << I2S_CTRLA_CKEN_Pos)
...
#define I2S_CTRLA_SEREN_Msk         (__U(0x3) << I2S_CTRLA_SEREN_Pos)
#define I2S_CTRLA_SEREN(value)      (I2S_CTRLA_SEREN_Msk & ((value) << I2S_CTRLA_SEREN_Pos))
#define I2S_CTRLA_MASK              __U(0x3F)     /**< \brief (I2S_CTRLA) MASK Register */
...
#define I2S_CLKCTRL_RESETVALUE      __U(0x00000000) /**< \brief (I2S_CLKCTRL reset_value) Clock Unit n Control */

#define I2S_CLKCTRL_SLOTSIZE_Pos    0            /**< \brief (I2S_CLKCTRL) Slot Size */
#define I2S_CLKCTRL_SLOTSIZE_Msk    (__U(0x3) << I2S_CLKCTRL_SLOTSIZE_Pos)
#define I2S_CLKCTRL_SLOTSIZE(value) (I2S_CLKCTRL_SLOTSIZE_Msk & ((value) << I2S_CLKCTRL_SLOTSIZE_Pos))
#define   I2S_CLKCTRL_SLOTSIZE_8_Val      __U(0x0)   /**< \brief (I2S_CLKCTRL) 8-bit Slot for Clock Unit n */
#define   I2S_CLKCTRL_SLOTSIZE_16_Val     __U(0x1)   /**< \brief (I2S_CLKCTRL) 16-bit Slot for Clock Unit n */
#define   I2S_CLKCTRL_SLOTSIZE_24_Val     __U(0x2)   /**< \brief (I2S_CLKCTRL) 24-bit Slot for Clock Unit n */
#define   I2S_CLKCTRL_SLOTSIZE_32_Val     __U(0x3)   /**< \brief (I2S_CLKCTRL) 32-bit Slot for Clock Unit n */
...
#define I2S_CLKCTRL_NBSLOTS_Msk     (__U(0x7) << I2S_CLKCTRL_NBSLOTS_Pos)
...
#define I2S_CLKCTRL_FSWIDTH_Msk     (__U(0x3) << I2S_CLKCTRL_FSWIDTH_Pos)
#define I2S_CLKCTRL_FSWIDTH(value)  (I2S_CLKCTRL_FSWIDTH_Msk & ((value) << I2S_CLKCTRL_FSWIDTH_Pos))
#define   I2S_CLKCTRL_FSWIDTH_SLOT_Val    __U(0x0)   /**< \brief (I2S_CLKCTRL) Frame Sync Pulse is 1 Slot wide (default for I2S protocol) */
#define   I2S_CLKCTRL_FSWIDTH_HALF_Val    __U(0x1)   /**< \brief (I2S_CLKCTRL) Frame Sync Pulse is half a Frame wide */
#define   I2S_CLKCTRL_FSWIDTH_BIT_Val     __U(0x2)   /**< \brief (I2S_CLKCTRL) Frame Sync Pulse is 1 Bit wide */
#define   I2S_CLKCTRL_FSWIDTH_BURST_Val   __U(0x3)   /**< \brief (I2S_CLKCTRL) Clock Unit n operates in Burst mode, with a 1-bit wide Frame Sync pulse per Data sample, only when Data transfer is requested */
...
#define I2S_CLKCTRL_BITDELAY        (__U(0x1) << I2S_CLKCTRL_BITDELAY_Pos)
#define   I2S_CLKCTRL_BITDELAY_LJ_Val     __U(0x0)   /**< \brief (I2S_CLKCTRL) Left Justified (0 Bit Delay) */
#define   I2S_CLKCTRL_BITDELAY_I2S_Val    __U(0x1)   /**< \brief (I2S_CLKCTRL) I2S (1 Bit Delay) */
...
#define I2S_CLKCTRL_FSSEL           (__U(0x1) << I2S_CLKCTRL_FSSEL_Pos)
#define   I2S_CLKCTRL_FSSEL_SCKDIV_Val    __U(0x0)   /**< \brief (I2S_CLKCTRL) Divided Serial Clock n is used as Frame Sync n source */
#define   I2S_CLKCTRL_FSSEL_FSPIN_Val     __U(0x1)   /**< \brief (I2S_CLKCTRL) FSn input pin is used as Frame Sync n source */
...
#define I2S_CLKCTRL_FSINV           (__U(0x1) << I2S_CLKCTRL_FSINV_Pos)
#define I2S_CLKCTRL_SCKSEL_Pos      12           /**< \brief (I2S_CLKCTRL) Serial Clock Select */
#define I2S_CLKCTRL_SCKSEL          (__U(0x1) << I2S_CLKCTRL_SCKSEL_Pos)
#define   I2S_CLKCTRL_SCKSEL_MCKDIV_Val   __U(0x0)   /**< \brief (I2S_CLKCTRL) Divided Master Clock n is used as Serial Clock n source */
#define   I2S_CLKCTRL_SCKSEL_SCKPIN_Val   __U(0x1)   /**< \brief (I2S_CLKCTRL) SCKn input pin is used as Serial Clock n source */
...
#define I2S_CLKCTRL_MCKSEL          (__U(0x1) << I2S_CLKCTRL_MCKSEL_Pos)
#define   I2S_CLKCTRL_MCKSEL_GCLK_Val     __U(0x0)   /**< \brief (I2S_CLKCTRL) GCLK_I2S_n is used as Master Clock n source */
#define   I2S_CLKCTRL_MCKSEL_MCKPIN_Val   __U(0x1)   /**< \brief (I2S_CLKCTRL) MCKn input pin is used as Master Clock n source */
...
#define I2S_CLKCTRL_MCKEN           (__U(0x1) << I2S_CLKCTRL_MCKEN_Pos)
#define I2S_CLKCTRL_MCKDIV_Pos      19           /**< \brief (I2S_CLKCTRL) Master Clock Division Factor */
#define I2S_CLKCTRL_MCKDIV_Msk      (__U(0x1F) << I2S_CLKCTRL_MCKDIV_Pos)
...
#define I2S_CLKCTRL_MCKOUTDIV_Msk   (__U(0x1F) << I2S_CLKCTRL_MCKOUTDIV_Pos)
...
#define I2S_CLKCTRL_FSOUTINV        (__U(0x1) << I2S_CLKCTRL_FSOUTINV_Pos)
#define I2S_CLKCTRL_SCKOUTINV_Pos   30           /**< \brief (I2S_CLKCTRL) Serial Clock Output Invert */
#define I2S_CLKCTRL_SCKOUTINV       (__U(0x1) << I2S_CLKCTRL_SCKOUTINV_Pos)
#define I2S_CLKCTRL_MCKOUTINV_Pos   31           /**< \brief (I2S_CLKCTRL) Master Clock Output Invert */
#define I2S_CLKCTRL_MCKOUTINV       (__U(0x1) << I2S_CLKCTRL_MCKOUTINV_Pos)
#define I2S_CLKCTRL_MASK            __U(0xFFFD19FF) /**< \brief (I2S_CLKCTRL) MASK Register */
...
#define I2S_INTENCLR_RESETVALUE     __U(0x0000)   /**< \brief (I2S_INTENCLR reset_value) Interrupt Enable Clear */
...
#define I2S_INTENCLR_RXRDY_Msk      (__U(0x3) << I2S_INTENCLR_RXRDY_Pos)
...
#define I2S_INTENCLR_RXOR_Msk       (__U(0x3) << I2S_INTENCLR_RXOR_Pos)
...
#define I2S_INTENCLR_TXRDY_Msk      (__U(0x3) << I2S_INTENCLR_TXRDY_Pos)
...
#define I2S_INTENCLR_TXUR_Msk       (__U(0x3) << I2S_INTENCLR_TXUR_Pos)
#define I2S_INTENCLR_TXUR(value)    (I2S_INTENCLR_TXUR_Msk & ((value) << I2S_INTENCLR_TXUR_Pos))
#define I2S_INTENCLR_MASK           __U(0x3333)   /**< \brief (I2S_INTENCLR) MASK Register */
...
#define I2S_INTENSET_RESETVALUE     __U(0x0000)   /**< \brief (I2S_INTENSET reset_value) Interrupt Enable Set */
...
#define I2S_INTENSET_RXRDY_Msk      (__U(0x3) << I2S_INTENSET_RXRDY_Pos)
...
#define I2S_INTENSET_RXOR_Msk       (__U(0x3) << I2S_INTENSET_RXOR_Pos)
...
#define I2S_INTENSET_TXRDY_Msk      (__U(0x3) << I2S_INTENSET_TXRDY_Pos)
...
#define I2S_INTENSET_TXUR_Msk       (__U(0x3) << I2S_INTENSET_TXUR_Pos)
#define I2S_INTENSET_TXUR(value)    (I2S_INTENSET_TXUR_Msk & ((value) << I2S_INTENSET_TXUR_Pos))
#define I2S_INTENSET_MASK           __U(0x3333)   /**< \brief (I2S_INTENSET) MASK Register */
...
#define I2S_INTFLAG_RESETVALUE      __U(0x0000)   /**< \brief (I2S_INTFLAG reset_value) Interrupt Flag Status and Clear */
...
#define I2S_INTFLAG_RXRDY_Msk       (__U(0x3) << I2S_INTFLAG_RXRDY_Pos)
...
#define I2S_INTFLAG_RXOR_Msk        (__U(0x3) << I2S_INTFLAG_RXOR_Pos)
...
#define I2S_INTFLAG_TXRDY_Msk       (__U(0x3) << I2S_INTFLAG_TXRDY_Pos)
...
#define I2S_INTFLAG_TXUR_Msk        (__U(0x3) << I2S_INTFLAG_TXUR_Pos)
#define I2S_INTFLAG_TXUR(value)     (I2S_INTFLAG_TXUR_Msk & ((value) << I2S_INTFLAG_TXUR_Pos))
#define I2S_INTFLAG_MASK            __U(0x3333)   /**< \brief (I2S_INTFLAG) MASK Register */
...
#define I2S_SYNCBUSY_RESETVALUE     __U(0x0000)   /**< \brief (I2S_SYNCBUSY reset_value) Synchronization Status */

#define I2S_SYNCBUSY_SWRST_Pos      0            /**< \brief (I2S_SYNCBUSY) Software Reset Synchronization Status */
#define I2S_SYNCBUSY_SWRST          (__U(0x1) << I2S_SYNCBUSY_SWRST_Pos)
#define I2S_SYNCBUSY_ENABLE_Pos     1            /**< \brief (I2S_SYNCBUSY) Enable Synchronization Status */
#define I2S_SYNCBUSY_ENABLE         (__U(0x1) << I2S_SYNCBUSY_ENABLE_Pos)
...
#define I2S_SYNCBUSY_CKEN_Msk       (__U(0x3) << I2S_SYNCBUSY_CKEN_Pos)
...
#define I2S_SYNCBUSY_SEREN_Msk      (__U(0x3) << I2S_SYNCBUSY_SEREN_Pos)
...
#define I2S_SYNCBUSY_DATA_Msk       (__U(0x3) << I2S_SYNCBUSY_DATA_Pos)
#define I2S_SYNCBUSY_DATA(value)    (I2S_SYNCBUSY_DATA_Msk & ((value) << I2S_SYNCBUSY_DATA_Pos))
#define I2S_SYNCBUSY_MASK           __U(0x033F)   /**< \brief (I2S_SYNCBUSY) MASK Register */
...
#define I2S_SERCTRL_RESETVALUE      __U(0x00000000) /**< \brief (I2S_SERCTRL reset_value) Serializer n Control */

#define I2S_SERCTRL_SERMODE_Pos     0            /**< \brief (I2S_SERCTRL) Serializer Mode */
#define I2S_SERCTRL_SERMODE_Msk     (__U(0x3) << I2S_SERCTRL_SERMODE_Pos)
#define I2S_SERCTRL_SERMODE(value)  (I2S_SERCTRL_SERMODE_Msk & ((value) << I2S_SERCTRL_SERMODE_Pos))
#define   I2S_SERCTRL_SERMODE_RX_Val      __U(0x0)   /**< \brief (I2S_SERCTRL) Receive */
#define   I2S_SERCTRL_SERMODE_TX_Val      __U(0x1)   /**< \brief (I2S_SERCTRL) Transmit */
#define   I2S_SERCTRL_SERMODE_PDM2_Val    __U(0x2)   /**< \brief (I2S_SERCTRL) Receive one PDM data on each serial clock edge */
...
#define I2S_SERCTRL_TXDEFAULT_Msk   (__U(0x3) << I2S_SERCTRL_TXDEFAULT_Pos)
#define I2S_SERCTRL_TXDEFAULT(value) (I2S_SERCTRL_TXDEFAULT_Msk & ((value) << I2S_SERCTRL_TXDEFAULT_Pos))
#define   I2S_SERCTRL_TXDEFAULT_ZERO_Val  __U(0x0)   /**< \brief (I2S_SERCTRL) Output Default Value is 0 */
#define   I2S_SERCTRL_TXDEFAULT_ONE_Val   __U(0x1)   /**< \brief (I2S_SERCTRL) Output Default Value is 1 */
#define   I2S_SERCTRL_TXDEFAULT_HIZ_Val   __U(0x3)   /**< \brief (I2S_SERCTRL) Output Default Value is high impedance */
...
#define I2S_SERCTRL_TXSAME          (__U(0x1) << I2S_SERCTRL_TXSAME_Pos)
#define   I2S_SERCTRL_TXSAME_ZERO_Val     __U(0x0)   /**< \brief (I2S_SERCTRL) Zero data transmitted in case of underrun */
#define   I2S_SERCTRL_TXSAME_SAME_Val     __U(0x1)   /**< \brief (I2S_SERCTRL) Last data transmitted in case of underrun */
...
#define I2S_SERCTRL_CLKSEL          (__U(0x1) << I2S_SERCTRL_CLKSEL_Pos)
#define   I2S_SERCTRL_CLKSEL_CLK0_Val     __U(0x0)   /**< \brief (I2S_SERCTRL) Use Clock Unit 0 */
#define   I2S_SERCTRL_CLKSEL_CLK1_Val     __U(0x1)   /**< \brief (I2S_SERCTRL) Use Clock Unit 1 */
...
#define I2S_SERCTRL_SLOTADJ         (__U(0x1) << I2S_SERCTRL_SLOTADJ_Pos)
#define   I2S_SERCTRL_SLOTADJ_RIGHT_Val   __U(0x0)   /**< \brief (I2S_SERCTRL) Data is right adjusted in slot */
#define   I2S_SERCTRL_SLOTADJ_LEFT_Val    __U(0x1)   /**< \brief (I2S_SERCTRL) Data is left adjusted in slot */
...
#define I2S_SERCTRL_DATASIZE_Msk    (__U(0x7) << I2S_SERCTRL_DATASIZE_Pos)
#define I2S_SERCTRL_DATASIZE(value) (I2S_SERCTRL_DATASIZE_Msk & ((value) << I2S_SERCTRL_DATASIZE_Pos))
#define   I2S_SERCTRL_DATASIZE_32_Val     __U(0x0)   /**< \brief (I2S_SERCTRL) 32 bits */
#define   I2S_SERCTRL_DATASIZE_24_Val     __U(0x1)   /**< \brief (I2S_SERCTRL) 24 bits */
#define   I2S_SERCTRL_DATASIZE_20_Val     __U(0x2)   /**< \brief (I2S_SERCTRL) 20 bits */
#define   I2S_SERCTRL_DATASIZE_18_Val     __U(0x3)   /**< \brief (I2S_SERCTRL) 18 bits */
#define   I2S_SERCTRL_DATASIZE_16_Val     __U(0x4)   /**< \brief (I2S_SERCTRL) 16 bits */
#define   I2S_SERCTRL_DATASIZE_16C_Val    __U(0x5)   /**< \brief (I2S_SERCTRL) 16 bits compact stereo */
#define   I2S_SERCTRL_DATASIZE_8_Val      __U(0x6)   /**< \brief (I2S_SERCTRL) 8 bits */
#define   I2S_SERCTRL_DATASIZE_8C_Val     __U(0x7)   /**< \brief (I2S_SERCTRL) 8 bits compact stereo */
...
#define I2S_SERCTRL_WORDADJ         (__U(0x1) << I2S_SERCTRL_WORDADJ_Pos)
#define   I2S_SERCTRL_WORDADJ_RIGHT_Val   __U(0x0)   /**< \brief (I2S_SERCTRL) Data is right adjusted in word */
#define   I2S_SERCTRL_WORDADJ_LEFT_Val    __U(0x1)   /**< \brief (I2S_SERCTRL) Data is left adjusted in word */
...
#define I2S_SERCTRL_EXTEND_Msk      (__U(0x3) << I2S_SERCTRL_EXTEND_Pos)
#define I2S_SERCTRL_EXTEND(value)   (I2S_SERCTRL_EXTEND_Msk & ((value) << I2S_SERCTRL_EXTEND_Pos))
#define   I2S_SERCTRL_EXTEND_ZERO_Val     __U(0x0)   /**< \brief (I2S_SERCTRL) Extend with zeroes */
#define   I2S_SERCTRL_EXTEND_ONE_Val      __U(0x1)   /**< \brief (I2S_SERCTRL) Extend with ones */
#define   I2S_SERCTRL_EXTEND_MSBIT_Val    __U(0x2)   /**< \brief (I2S_SERCTRL) Extend with Most Significant Bit */
#define   I2S_SERCTRL_EXTEND_LSBIT_Val    __U(0x3)   /**< \brief (I2S_SERCTRL) Extend with Least Significant Bit */
...
#define I2S_SERCTRL_BITREV          (__U(0x1) << I2S_SERCTRL_BITREV_Pos)
#define   I2S_SERCTRL_BITREV_MSBIT_Val    __U(0x0)   /**< \brief (I2S_SERCTRL) Transfer Data Most Significant Bit (MSB) first (default for I2S protocol) */
#define   I2S_SERCTRL_BITREV_LSBIT_Val    __U(0x1)   /**< \brief (I2S_SERCTRL) Transfer Data Least Significant Bit (LSB) first */
...
#define I2S_SERCTRL_SLOTDIS_Msk     (__U(0xFF) << I2S_SERCTRL_SLOTDIS_Pos)
...
#define I2S_SERCTRL_MONO            (__U(0x1) << I2S_SERCTRL_MONO_Pos)
#define   I2S_SERCTRL_MONO_STEREO_Val     __U(0x0)   /**< \brief (I2S_SERCTRL) Normal mode */
#define   I2S_SERCTRL_MONO_MONO_Val       __U(0x1)   /**< \brief (I2S_SERCTRL) Left channel data is duplicated to right channel */
...
#define I2S_SERCTRL_DMA             (__U(0x1) << I2S_SERCTRL_DMA_Pos)
#define   I2S_SERCTRL_DMA_SINGLE_Val      __U(0x0)   /**< \brief (I2S_SERCTRL) Single DMA channel */
#define   I2S_SERCTRL_DMA_MULTIPLE_Val    __U(0x1)   /**< \brief (I2S_SERCTRL) One DMA channel per data channel */
...
#define I2S_SERCTRL_RXLOOP          (__U(0x1) << I2S_SERCTRL_RXLOOP_Pos)
#define I2S_SERCTRL_MASK            __U(0x07FFF7BF) /**< \brief (I2S_SERCTRL) MASK Register */
...
#define I2S_DATA_RESETVALUE         __U(0x00000000) /**< \brief (I2S_DATA reset_value) Data n */

#define I2S_DATA_DATA_Pos           0            /**< \brief (I2S_DATA) Sample Data */
#define I2S_DATA_DATA_Msk           (__U(0xFFFFFFFF) << I2S_DATA_DATA_Pos)
#define I2S_DATA_DATA(value)        (I2S_DATA_DATA_Msk & ((value) << I2S_DATA_DATA_Pos))
#define I2S_DATA_MASK               __U(0xFFFFFFFF) /**< \brief (I2S_DATA) MASK Register */
