...
#define EVSYS_CTRL_RESETVALUE       __U(0x00)     /**< \brief (EVSYS_CTRL reset_value) Control */

#define EVSYS_CTRL_SWRST_Pos        0            /**< \brief (EVSYS_CTRL) Software Reset */
#define EVSYS_CTRL_SWRST            (__U(0x1) << EVSYS_CTRL_SWRST_Pos)
#define EVSYS_CTRL_GCLKREQ_Pos      4            /**< \brief (EVSYS_CTRL) Generic Clock Requests */
#define EVSYS_CTRL_GCLKREQ          (__U(0x1) << EVSYS_CTRL_GCLKREQ_Pos)
#define EVSYS_CTRL_MASK             __U(0x11)     /**< \brief (EVSYS_CTRL) MASK Register */
...
#define EVSYS_CHANNEL_RESETVALUE    __U(0x00000000) /**< \brief (EVSYS_CHANNEL reset_value) Channel */

#define EVSYS_CHANNEL_CHANNEL_Pos   0            /**< \brief (EVSYS_CHANNEL) Channel Selection */
#define EVSYS_CHANNEL_CHANNEL_Msk   (__U(0xF) << EVSYS_CHANNEL_CHANNEL_Pos)
...
#define EVSYS_CHANNEL_SWEVT         (__U(0x1) << EVSYS_CHANNEL_SWEVT_Pos)
#define EVSYS_CHANNEL_EVGEN_Pos     16           /**< \brief (EVSYS_CHANNEL) Event Generator Selection */
#define EVSYS_CHANNEL_EVGEN_Msk     (__U(0x7F) << EVSYS_CHANNEL_EVGEN_Pos)
#define EVSYS_CHANNEL_EVGEN(value)  (EVSYS_CHANNEL_EVGEN_Msk & ((value) << EVSYS_CHANNEL_EVGEN_Pos))
#define EVSYS_CHANNEL_PATH_Pos      24           /**< \brief (EVSYS_CHANNEL) Path Selection */
#define EVSYS_CHANNEL_PATH_Msk      (__U(0x3) << EVSYS_CHANNEL_PATH_Pos)
#define EVSYS_CHANNEL_PATH(value)   (EVSYS_CHANNEL_PATH_Msk & ((value) << EVSYS_CHANNEL_PATH_Pos))
#define   EVSYS_CHANNEL_PATH_SYNCHRONOUS_Val __U(0x0)   /**< \brief (EVSYS_CHANNEL) Synchronous path */
#define   EVSYS_CHANNEL_PATH_RESYNCHRONIZED_Val __U(0x1)   /**< \brief (EVSYS_CHANNEL) Resynchronized path */
#define   EVSYS_CHANNEL_PATH_ASYNCHRONOUS_Val __U(0x2)   /**< \brief (EVSYS_CHANNEL) Asynchronous path */
...
#define EVSYS_CHANNEL_EDGSEL_Msk    (__U(0x3) << EVSYS_CHANNEL_EDGSEL_Pos)
#define EVSYS_CHANNEL_EDGSEL(value) (EVSYS_CHANNEL_EDGSEL_Msk & ((value) << EVSYS_CHANNEL_EDGSEL_Pos))
#define   EVSYS_CHANNEL_EDGSEL_NO_EVT_OUTPUT_Val __U(0x0)   /**< \brief (EVSYS_CHANNEL) No event output when using the resynchronized or synchronous path */
#define   EVSYS_CHANNEL_EDGSEL_RISING_EDGE_Val __U(0x1)   /**< \brief (EVSYS_CHANNEL) Event detection only on the rising edge of the signal from the event generator when using the resynchronized or synchronous path */
#define   EVSYS_CHANNEL_EDGSEL_FALLING_EDGE_Val __U(0x2)   /**< \brief (EVSYS_CHANNEL) Event detection only on the falling edge of the signal from the event generator when using the resynchronized or synchronous path */
#define   EVSYS_CHANNEL_EDGSEL_BOTH_EDGES_Val __U(0x3)   /**< \brief (EVSYS_CHANNEL) Event detection on rising and falling edges of the signal from the event generator when using the resynchronized or synchronous path */
...
#define EVSYS_CHANNEL_MASK          __U(0x0F7F010F) /**< \brief (EVSYS_CHANNEL) MASK Register */
...
#define EVSYS_USER_RESETVALUE       __U(0x0000)   /**< \brief (EVSYS_USER reset_value) User Multiplexer */

#define EVSYS_USER_USER_Pos         0            /**< \brief (EVSYS_USER) User Multiplexer Selection */
#define EVSYS_USER_USER_Msk         (__U(0x1F) << EVSYS_USER_USER_Pos)
...
#define EVSYS_USER_CHANNEL_Msk      (__U(0x1F) << EVSYS_USER_CHANNEL_Pos)
#define EVSYS_USER_CHANNEL(value)   (EVSYS_USER_CHANNEL_Msk & ((value) << EVSYS_USER_CHANNEL_Pos))
#define   EVSYS_USER_CHANNEL_0_Val        __U(0x0)   /**< \brief (EVSYS_USER) No Channel Output Selected */
#define EVSYS_USER_CHANNEL_0        (EVSYS_USER_CHANNEL_0_Val      << EVSYS_USER_CHANNEL_Pos)
#define EVSYS_USER_MASK             __U(0x1F1F)   /**< \brief (EVSYS_USER) MASK Register */
...
#define EVSYS_CHSTATUS_RESETVALUE   __U(0x000F00FF) /**< \brief (EVSYS_CHSTATUS reset_value) Channel Status */
...
#define EVSYS_CHSTATUS_USRRDY_Msk   (__U(0xFF) << EVSYS_CHSTATUS_USRRDY_Pos)
...
#define EVSYS_CHSTATUS_CHBUSY_Msk   (__U(0xFF) << EVSYS_CHSTATUS_CHBUSY_Pos)
...
#define EVSYS_CHSTATUS_USRRDYp8_Msk (__U(0xF) << EVSYS_CHSTATUS_USRRDYp8_Pos)
...
#define EVSYS_CHSTATUS_CHBUSYp8_Msk (__U(0xF) << EVSYS_CHSTATUS_CHBUSYp8_Pos)
#define EVSYS_CHSTATUS_CHBUSYp8(value) (EVSYS_CHSTATUS_CHBUSYp8_Msk & ((value) << EVSYS_CHSTATUS_CHBUSYp8_Pos))
#define EVSYS_CHSTATUS_MASK         __U(0x0F0FFFFF) /**< \brief (EVSYS_CHSTATUS) MASK Register */
...
#define EVSYS_INTENCLR_RESETVALUE   __U(0x00000000) /**< \brief (EVSYS_INTENCLR reset_value) Interrupt Enable Clear */
...
#define EVSYS_INTENCLR_OVR_Msk      (__U(0xFF) << EVSYS_INTENCLR_OVR_Pos)
...
#define EVSYS_INTENCLR_EVD_Msk      (__U(0xFF) << EVSYS_INTENCLR_EVD_Pos)
...
#define EVSYS_INTENCLR_OVRp8_Msk    (__U(0xF) << EVSYS_INTENCLR_OVRp8_Pos)
...
#define EVSYS_INTENCLR_EVDp8_Msk    (__U(0xF) << EVSYS_INTENCLR_EVDp8_Pos)
#define EVSYS_INTENCLR_EVDp8(value) (EVSYS_INTENCLR_EVDp8_Msk & ((value) << EVSYS_INTENCLR_EVDp8_Pos))
#define EVSYS_INTENCLR_MASK         __U(0x0F0FFFFF) /**< \brief (EVSYS_INTENCLR) MASK Register */
...
#define EVSYS_INTENSET_RESETVALUE   __U(0x00000000) /**< \brief (EVSYS_INTENSET reset_value) Interrupt Enable Set */
...
#define EVSYS_INTENSET_OVR_Msk      (__U(0xFF) << EVSYS_INTENSET_OVR_Pos)
...
#define EVSYS_INTENSET_EVD_Msk      (__U(0xFF) << EVSYS_INTENSET_EVD_Pos)
...
#define EVSYS_INTENSET_OVRp8_Msk    (__U(0xF) << EVSYS_INTENSET_OVRp8_Pos)
...
#define EVSYS_INTENSET_EVDp8_Msk    (__U(0xF) << EVSYS_INTENSET_EVDp8_Pos)
#define EVSYS_INTENSET_EVDp8(value) (EVSYS_INTENSET_EVDp8_Msk & ((value) << EVSYS_INTENSET_EVDp8_Pos))
#define EVSYS_INTENSET_MASK         __U(0x0F0FFFFF) /**< \brief (EVSYS_INTENSET) MASK Register */
...
#define EVSYS_INTFLAG_RESETVALUE    __U(0x00000000) /**< \brief (EVSYS_INTFLAG reset_value) Interrupt Flag Status and Clear */
...
#define EVSYS_INTFLAG_OVR_Msk       (__U(0xFF) << EVSYS_INTFLAG_OVR_Pos)
...
#define EVSYS_INTFLAG_EVD_Msk       (__U(0xFF) << EVSYS_INTFLAG_EVD_Pos)
...
#define EVSYS_INTFLAG_OVRp8_Msk     (__U(0xF) << EVSYS_INTFLAG_OVRp8_Pos)
...
#define EVSYS_INTFLAG_EVDp8_Msk     (__U(0xF) << EVSYS_INTFLAG_EVDp8_Pos)
#define EVSYS_INTFLAG_EVDp8(value)  (EVSYS_INTFLAG_EVDp8_Msk & ((value) << EVSYS_INTFLAG_EVDp8_Pos))
#define EVSYS_INTFLAG_MASK          __U(0x0F0FFFFF) /**< \brief (EVSYS_INTFLAG) MASK Register */
