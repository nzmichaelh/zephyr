...
#define RTC_MODE0_CTRL_RESETVALUE   __U(0x0000)   /**< \brief (RTC_MODE0_CTRL reset_value) MODE0 Control */

#define RTC_MODE0_CTRL_SWRST_Pos    0            /**< \brief (RTC_MODE0_CTRL) Software Reset */
#define RTC_MODE0_CTRL_SWRST        (__U(0x1) << RTC_MODE0_CTRL_SWRST_Pos)
#define RTC_MODE0_CTRL_ENABLE_Pos   1            /**< \brief (RTC_MODE0_CTRL) Enable */
#define RTC_MODE0_CTRL_ENABLE       (__U(0x1) << RTC_MODE0_CTRL_ENABLE_Pos)
#define RTC_MODE0_CTRL_MODE_Pos     2            /**< \brief (RTC_MODE0_CTRL) Operating Mode */
#define RTC_MODE0_CTRL_MODE_Msk     (__U(0x3) << RTC_MODE0_CTRL_MODE_Pos)
#define RTC_MODE0_CTRL_MODE(value)  (RTC_MODE0_CTRL_MODE_Msk & ((value) << RTC_MODE0_CTRL_MODE_Pos))
#define   RTC_MODE0_CTRL_MODE_COUNT32_Val __U(0x0)   /**< \brief (RTC_MODE0_CTRL) Mode 0: 32-bit Counter */
#define   RTC_MODE0_CTRL_MODE_COUNT16_Val __U(0x1)   /**< \brief (RTC_MODE0_CTRL) Mode 1: 16-bit Counter */
#define   RTC_MODE0_CTRL_MODE_CLOCK_Val   __U(0x2)   /**< \brief (RTC_MODE0_CTRL) Mode 2: Clock/Calendar */
...
#define RTC_MODE0_CTRL_MATCHCLR     (__U(0x1) << RTC_MODE0_CTRL_MATCHCLR_Pos)
#define RTC_MODE0_CTRL_PRESCALER_Pos 8            /**< \brief (RTC_MODE0_CTRL) Prescaler */
#define RTC_MODE0_CTRL_PRESCALER_Msk (__U(0xF) << RTC_MODE0_CTRL_PRESCALER_Pos)
#define RTC_MODE0_CTRL_PRESCALER(value) (RTC_MODE0_CTRL_PRESCALER_Msk & ((value) << RTC_MODE0_CTRL_PRESCALER_Pos))
#define   RTC_MODE0_CTRL_PRESCALER_DIV1_Val __U(0x0)   /**< \brief (RTC_MODE0_CTRL) CLK_RTC_CNT = GCLK_RTC/1 */
#define   RTC_MODE0_CTRL_PRESCALER_DIV2_Val __U(0x1)   /**< \brief (RTC_MODE0_CTRL) CLK_RTC_CNT = GCLK_RTC/2 */
#define   RTC_MODE0_CTRL_PRESCALER_DIV4_Val __U(0x2)   /**< \brief (RTC_MODE0_CTRL) CLK_RTC_CNT = GCLK_RTC/4 */
#define   RTC_MODE0_CTRL_PRESCALER_DIV8_Val __U(0x3)   /**< \brief (RTC_MODE0_CTRL) CLK_RTC_CNT = GCLK_RTC/8 */
#define   RTC_MODE0_CTRL_PRESCALER_DIV16_Val __U(0x4)   /**< \brief (RTC_MODE0_CTRL) CLK_RTC_CNT = GCLK_RTC/16 */
#define   RTC_MODE0_CTRL_PRESCALER_DIV32_Val __U(0x5)   /**< \brief (RTC_MODE0_CTRL) CLK_RTC_CNT = GCLK_RTC/32 */
#define   RTC_MODE0_CTRL_PRESCALER_DIV64_Val __U(0x6)   /**< \brief (RTC_MODE0_CTRL) CLK_RTC_CNT = GCLK_RTC/64 */
#define   RTC_MODE0_CTRL_PRESCALER_DIV128_Val __U(0x7)   /**< \brief (RTC_MODE0_CTRL) CLK_RTC_CNT = GCLK_RTC/128 */
#define   RTC_MODE0_CTRL_PRESCALER_DIV256_Val __U(0x8)   /**< \brief (RTC_MODE0_CTRL) CLK_RTC_CNT = GCLK_RTC/256 */
#define   RTC_MODE0_CTRL_PRESCALER_DIV512_Val __U(0x9)   /**< \brief (RTC_MODE0_CTRL) CLK_RTC_CNT = GCLK_RTC/512 */
#define   RTC_MODE0_CTRL_PRESCALER_DIV1024_Val __U(0xA)   /**< \brief (RTC_MODE0_CTRL) CLK_RTC_CNT = GCLK_RTC/1024 */
...
#define RTC_MODE0_CTRL_MASK         __U(0x0F8F)   /**< \brief (RTC_MODE0_CTRL) MASK Register */
...
#define RTC_MODE1_CTRL_RESETVALUE   __U(0x0000)   /**< \brief (RTC_MODE1_CTRL reset_value) MODE1 Control */

#define RTC_MODE1_CTRL_SWRST_Pos    0            /**< \brief (RTC_MODE1_CTRL) Software Reset */
#define RTC_MODE1_CTRL_SWRST        (__U(0x1) << RTC_MODE1_CTRL_SWRST_Pos)
#define RTC_MODE1_CTRL_ENABLE_Pos   1            /**< \brief (RTC_MODE1_CTRL) Enable */
#define RTC_MODE1_CTRL_ENABLE       (__U(0x1) << RTC_MODE1_CTRL_ENABLE_Pos)
#define RTC_MODE1_CTRL_MODE_Pos     2            /**< \brief (RTC_MODE1_CTRL) Operating Mode */
#define RTC_MODE1_CTRL_MODE_Msk     (__U(0x3) << RTC_MODE1_CTRL_MODE_Pos)
#define RTC_MODE1_CTRL_MODE(value)  (RTC_MODE1_CTRL_MODE_Msk & ((value) << RTC_MODE1_CTRL_MODE_Pos))
#define   RTC_MODE1_CTRL_MODE_COUNT32_Val __U(0x0)   /**< \brief (RTC_MODE1_CTRL) Mode 0: 32-bit Counter */
#define   RTC_MODE1_CTRL_MODE_COUNT16_Val __U(0x1)   /**< \brief (RTC_MODE1_CTRL) Mode 1: 16-bit Counter */
#define   RTC_MODE1_CTRL_MODE_CLOCK_Val   __U(0x2)   /**< \brief (RTC_MODE1_CTRL) Mode 2: Clock/Calendar */
...
#define RTC_MODE1_CTRL_PRESCALER_Msk (__U(0xF) << RTC_MODE1_CTRL_PRESCALER_Pos)
#define RTC_MODE1_CTRL_PRESCALER(value) (RTC_MODE1_CTRL_PRESCALER_Msk & ((value) << RTC_MODE1_CTRL_PRESCALER_Pos))
#define   RTC_MODE1_CTRL_PRESCALER_DIV1_Val __U(0x0)   /**< \brief (RTC_MODE1_CTRL) CLK_RTC_CNT = GCLK_RTC/1 */
#define   RTC_MODE1_CTRL_PRESCALER_DIV2_Val __U(0x1)   /**< \brief (RTC_MODE1_CTRL) CLK_RTC_CNT = GCLK_RTC/2 */
#define   RTC_MODE1_CTRL_PRESCALER_DIV4_Val __U(0x2)   /**< \brief (RTC_MODE1_CTRL) CLK_RTC_CNT = GCLK_RTC/4 */
#define   RTC_MODE1_CTRL_PRESCALER_DIV8_Val __U(0x3)   /**< \brief (RTC_MODE1_CTRL) CLK_RTC_CNT = GCLK_RTC/8 */
#define   RTC_MODE1_CTRL_PRESCALER_DIV16_Val __U(0x4)   /**< \brief (RTC_MODE1_CTRL) CLK_RTC_CNT = GCLK_RTC/16 */
#define   RTC_MODE1_CTRL_PRESCALER_DIV32_Val __U(0x5)   /**< \brief (RTC_MODE1_CTRL) CLK_RTC_CNT = GCLK_RTC/32 */
#define   RTC_MODE1_CTRL_PRESCALER_DIV64_Val __U(0x6)   /**< \brief (RTC_MODE1_CTRL) CLK_RTC_CNT = GCLK_RTC/64 */
#define   RTC_MODE1_CTRL_PRESCALER_DIV128_Val __U(0x7)   /**< \brief (RTC_MODE1_CTRL) CLK_RTC_CNT = GCLK_RTC/128 */
#define   RTC_MODE1_CTRL_PRESCALER_DIV256_Val __U(0x8)   /**< \brief (RTC_MODE1_CTRL) CLK_RTC_CNT = GCLK_RTC/256 */
#define   RTC_MODE1_CTRL_PRESCALER_DIV512_Val __U(0x9)   /**< \brief (RTC_MODE1_CTRL) CLK_RTC_CNT = GCLK_RTC/512 */
#define   RTC_MODE1_CTRL_PRESCALER_DIV1024_Val __U(0xA)   /**< \brief (RTC_MODE1_CTRL) CLK_RTC_CNT = GCLK_RTC/1024 */
...
#define RTC_MODE1_CTRL_MASK         __U(0x0F0F)   /**< \brief (RTC_MODE1_CTRL) MASK Register */
...
#define RTC_MODE2_CTRL_RESETVALUE   __U(0x0000)   /**< \brief (RTC_MODE2_CTRL reset_value) MODE2 Control */

#define RTC_MODE2_CTRL_SWRST_Pos    0            /**< \brief (RTC_MODE2_CTRL) Software Reset */
#define RTC_MODE2_CTRL_SWRST        (__U(0x1) << RTC_MODE2_CTRL_SWRST_Pos)
#define RTC_MODE2_CTRL_ENABLE_Pos   1            /**< \brief (RTC_MODE2_CTRL) Enable */
#define RTC_MODE2_CTRL_ENABLE       (__U(0x1) << RTC_MODE2_CTRL_ENABLE_Pos)
#define RTC_MODE2_CTRL_MODE_Pos     2            /**< \brief (RTC_MODE2_CTRL) Operating Mode */
#define RTC_MODE2_CTRL_MODE_Msk     (__U(0x3) << RTC_MODE2_CTRL_MODE_Pos)
#define RTC_MODE2_CTRL_MODE(value)  (RTC_MODE2_CTRL_MODE_Msk & ((value) << RTC_MODE2_CTRL_MODE_Pos))
#define   RTC_MODE2_CTRL_MODE_COUNT32_Val __U(0x0)   /**< \brief (RTC_MODE2_CTRL) Mode 0: 32-bit Counter */
#define   RTC_MODE2_CTRL_MODE_COUNT16_Val __U(0x1)   /**< \brief (RTC_MODE2_CTRL) Mode 1: 16-bit Counter */
#define   RTC_MODE2_CTRL_MODE_CLOCK_Val   __U(0x2)   /**< \brief (RTC_MODE2_CTRL) Mode 2: Clock/Calendar */
...
#define RTC_MODE2_CTRL_CLKREP       (__U(0x1) << RTC_MODE2_CTRL_CLKREP_Pos)
#define RTC_MODE2_CTRL_MATCHCLR_Pos 7            /**< \brief (RTC_MODE2_CTRL) Clear on Match */
#define RTC_MODE2_CTRL_MATCHCLR     (__U(0x1) << RTC_MODE2_CTRL_MATCHCLR_Pos)
#define RTC_MODE2_CTRL_PRESCALER_Pos 8            /**< \brief (RTC_MODE2_CTRL) Prescaler */
#define RTC_MODE2_CTRL_PRESCALER_Msk (__U(0xF) << RTC_MODE2_CTRL_PRESCALER_Pos)
#define RTC_MODE2_CTRL_PRESCALER(value) (RTC_MODE2_CTRL_PRESCALER_Msk & ((value) << RTC_MODE2_CTRL_PRESCALER_Pos))
#define   RTC_MODE2_CTRL_PRESCALER_DIV1_Val __U(0x0)   /**< \brief (RTC_MODE2_CTRL) CLK_RTC_CNT = GCLK_RTC/1 */
#define   RTC_MODE2_CTRL_PRESCALER_DIV2_Val __U(0x1)   /**< \brief (RTC_MODE2_CTRL) CLK_RTC_CNT = GCLK_RTC/2 */
#define   RTC_MODE2_CTRL_PRESCALER_DIV4_Val __U(0x2)   /**< \brief (RTC_MODE2_CTRL) CLK_RTC_CNT = GCLK_RTC/4 */
#define   RTC_MODE2_CTRL_PRESCALER_DIV8_Val __U(0x3)   /**< \brief (RTC_MODE2_CTRL) CLK_RTC_CNT = GCLK_RTC/8 */
#define   RTC_MODE2_CTRL_PRESCALER_DIV16_Val __U(0x4)   /**< \brief (RTC_MODE2_CTRL) CLK_RTC_CNT = GCLK_RTC/16 */
#define   RTC_MODE2_CTRL_PRESCALER_DIV32_Val __U(0x5)   /**< \brief (RTC_MODE2_CTRL) CLK_RTC_CNT = GCLK_RTC/32 */
#define   RTC_MODE2_CTRL_PRESCALER_DIV64_Val __U(0x6)   /**< \brief (RTC_MODE2_CTRL) CLK_RTC_CNT = GCLK_RTC/64 */
#define   RTC_MODE2_CTRL_PRESCALER_DIV128_Val __U(0x7)   /**< \brief (RTC_MODE2_CTRL) CLK_RTC_CNT = GCLK_RTC/128 */
#define   RTC_MODE2_CTRL_PRESCALER_DIV256_Val __U(0x8)   /**< \brief (RTC_MODE2_CTRL) CLK_RTC_CNT = GCLK_RTC/256 */
#define   RTC_MODE2_CTRL_PRESCALER_DIV512_Val __U(0x9)   /**< \brief (RTC_MODE2_CTRL) CLK_RTC_CNT = GCLK_RTC/512 */
#define   RTC_MODE2_CTRL_PRESCALER_DIV1024_Val __U(0xA)   /**< \brief (RTC_MODE2_CTRL) CLK_RTC_CNT = GCLK_RTC/1024 */
...
#define RTC_MODE2_CTRL_MASK         __U(0x0FCF)   /**< \brief (RTC_MODE2_CTRL) MASK Register */
...
#define RTC_READREQ_RESETVALUE      __U(0x0010)   /**< \brief (RTC_READREQ reset_value) Read Request */

#define RTC_READREQ_ADDR_Pos        0            /**< \brief (RTC_READREQ) Address */
#define RTC_READREQ_ADDR_Msk        (__U(0x3F) << RTC_READREQ_ADDR_Pos)
...
#define RTC_READREQ_RCONT           (__U(0x1) << RTC_READREQ_RCONT_Pos)
#define RTC_READREQ_RREQ_Pos        15           /**< \brief (RTC_READREQ) Read Request */
#define RTC_READREQ_RREQ            (__U(0x1) << RTC_READREQ_RREQ_Pos)
#define RTC_READREQ_MASK            __U(0xC03F)   /**< \brief (RTC_READREQ) MASK Register */
...
#define RTC_MODE0_EVCTRL_RESETVALUE __U(0x0000)   /**< \brief (RTC_MODE0_EVCTRL reset_value) MODE0 Event Control */
...
#define RTC_MODE0_EVCTRL_PEREO_Msk  (__U(0xFF) << RTC_MODE0_EVCTRL_PEREO_Pos)
...
#define RTC_MODE0_EVCTRL_CMPEO_Msk  (__U(0x1) << RTC_MODE0_EVCTRL_CMPEO_Pos)
...
#define RTC_MODE0_EVCTRL_OVFEO      (__U(0x1) << RTC_MODE0_EVCTRL_OVFEO_Pos)
#define RTC_MODE0_EVCTRL_MASK       __U(0x81FF)   /**< \brief (RTC_MODE0_EVCTRL) MASK Register */
...
#define RTC_MODE1_EVCTRL_RESETVALUE __U(0x0000)   /**< \brief (RTC_MODE1_EVCTRL reset_value) MODE1 Event Control */
...
#define RTC_MODE1_EVCTRL_PEREO_Msk  (__U(0xFF) << RTC_MODE1_EVCTRL_PEREO_Pos)
...
#define RTC_MODE1_EVCTRL_CMPEO_Msk  (__U(0x3) << RTC_MODE1_EVCTRL_CMPEO_Pos)
...
#define RTC_MODE1_EVCTRL_OVFEO      (__U(0x1) << RTC_MODE1_EVCTRL_OVFEO_Pos)
#define RTC_MODE1_EVCTRL_MASK       __U(0x83FF)   /**< \brief (RTC_MODE1_EVCTRL) MASK Register */
...
#define RTC_MODE2_EVCTRL_RESETVALUE __U(0x0000)   /**< \brief (RTC_MODE2_EVCTRL reset_value) MODE2 Event Control */
...
#define RTC_MODE2_EVCTRL_PEREO_Msk  (__U(0xFF) << RTC_MODE2_EVCTRL_PEREO_Pos)
...
#define RTC_MODE2_EVCTRL_ALARMEO_Msk (__U(0x1) << RTC_MODE2_EVCTRL_ALARMEO_Pos)
...
#define RTC_MODE2_EVCTRL_OVFEO      (__U(0x1) << RTC_MODE2_EVCTRL_OVFEO_Pos)
#define RTC_MODE2_EVCTRL_MASK       __U(0x81FF)   /**< \brief (RTC_MODE2_EVCTRL) MASK Register */
...
#define RTC_MODE0_INTENCLR_RESETVALUE __U(0x00)     /**< \brief (RTC_MODE0_INTENCLR reset_value) MODE0 Interrupt Enable Clear */
...
#define RTC_MODE0_INTENCLR_CMP_Msk  (__U(0x1) << RTC_MODE0_INTENCLR_CMP_Pos)
...
#define RTC_MODE0_INTENCLR_SYNCRDY  (__U(0x1) << RTC_MODE0_INTENCLR_SYNCRDY_Pos)
#define RTC_MODE0_INTENCLR_OVF_Pos  7            /**< \brief (RTC_MODE0_INTENCLR) Overflow Interrupt Enable */
#define RTC_MODE0_INTENCLR_OVF      (__U(0x1) << RTC_MODE0_INTENCLR_OVF_Pos)
#define RTC_MODE0_INTENCLR_MASK     __U(0xC1)     /**< \brief (RTC_MODE0_INTENCLR) MASK Register */
...
#define RTC_MODE1_INTENCLR_RESETVALUE __U(0x00)     /**< \brief (RTC_MODE1_INTENCLR reset_value) MODE1 Interrupt Enable Clear */
...
#define RTC_MODE1_INTENCLR_CMP_Msk  (__U(0x3) << RTC_MODE1_INTENCLR_CMP_Pos)
...
#define RTC_MODE1_INTENCLR_SYNCRDY  (__U(0x1) << RTC_MODE1_INTENCLR_SYNCRDY_Pos)
#define RTC_MODE1_INTENCLR_OVF_Pos  7            /**< \brief (RTC_MODE1_INTENCLR) Overflow Interrupt Enable */
#define RTC_MODE1_INTENCLR_OVF      (__U(0x1) << RTC_MODE1_INTENCLR_OVF_Pos)
#define RTC_MODE1_INTENCLR_MASK     __U(0xC3)     /**< \brief (RTC_MODE1_INTENCLR) MASK Register */
...
#define RTC_MODE2_INTENCLR_RESETVALUE __U(0x00)     /**< \brief (RTC_MODE2_INTENCLR reset_value) MODE2 Interrupt Enable Clear */
...
#define RTC_MODE2_INTENCLR_ALARM_Msk (__U(0x1) << RTC_MODE2_INTENCLR_ALARM_Pos)
...
#define RTC_MODE2_INTENCLR_SYNCRDY  (__U(0x1) << RTC_MODE2_INTENCLR_SYNCRDY_Pos)
#define RTC_MODE2_INTENCLR_OVF_Pos  7            /**< \brief (RTC_MODE2_INTENCLR) Overflow Interrupt Enable */
#define RTC_MODE2_INTENCLR_OVF      (__U(0x1) << RTC_MODE2_INTENCLR_OVF_Pos)
#define RTC_MODE2_INTENCLR_MASK     __U(0xC1)     /**< \brief (RTC_MODE2_INTENCLR) MASK Register */
...
#define RTC_MODE0_INTENSET_RESETVALUE __U(0x00)     /**< \brief (RTC_MODE0_INTENSET reset_value) MODE0 Interrupt Enable Set */
...
#define RTC_MODE0_INTENSET_CMP_Msk  (__U(0x1) << RTC_MODE0_INTENSET_CMP_Pos)
...
#define RTC_MODE0_INTENSET_SYNCRDY  (__U(0x1) << RTC_MODE0_INTENSET_SYNCRDY_Pos)
#define RTC_MODE0_INTENSET_OVF_Pos  7            /**< \brief (RTC_MODE0_INTENSET) Overflow Interrupt Enable */
#define RTC_MODE0_INTENSET_OVF      (__U(0x1) << RTC_MODE0_INTENSET_OVF_Pos)
#define RTC_MODE0_INTENSET_MASK     __U(0xC1)     /**< \brief (RTC_MODE0_INTENSET) MASK Register */
...
#define RTC_MODE1_INTENSET_RESETVALUE __U(0x00)     /**< \brief (RTC_MODE1_INTENSET reset_value) MODE1 Interrupt Enable Set */
...
#define RTC_MODE1_INTENSET_CMP_Msk  (__U(0x3) << RTC_MODE1_INTENSET_CMP_Pos)
...
#define RTC_MODE1_INTENSET_SYNCRDY  (__U(0x1) << RTC_MODE1_INTENSET_SYNCRDY_Pos)
#define RTC_MODE1_INTENSET_OVF_Pos  7            /**< \brief (RTC_MODE1_INTENSET) Overflow Interrupt Enable */
#define RTC_MODE1_INTENSET_OVF      (__U(0x1) << RTC_MODE1_INTENSET_OVF_Pos)
#define RTC_MODE1_INTENSET_MASK     __U(0xC3)     /**< \brief (RTC_MODE1_INTENSET) MASK Register */
...
#define RTC_MODE2_INTENSET_RESETVALUE __U(0x00)     /**< \brief (RTC_MODE2_INTENSET reset_value) MODE2 Interrupt Enable Set */
...
#define RTC_MODE2_INTENSET_ALARM_Msk (__U(0x1) << RTC_MODE2_INTENSET_ALARM_Pos)
...
#define RTC_MODE2_INTENSET_SYNCRDY  (__U(0x1) << RTC_MODE2_INTENSET_SYNCRDY_Pos)
#define RTC_MODE2_INTENSET_OVF_Pos  7            /**< \brief (RTC_MODE2_INTENSET) Overflow Interrupt Enable */
#define RTC_MODE2_INTENSET_OVF      (__U(0x1) << RTC_MODE2_INTENSET_OVF_Pos)
#define RTC_MODE2_INTENSET_MASK     __U(0xC1)     /**< \brief (RTC_MODE2_INTENSET) MASK Register */
...
#define RTC_MODE0_INTFLAG_RESETVALUE __U(0x00)     /**< \brief (RTC_MODE0_INTFLAG reset_value) MODE0 Interrupt Flag Status and Clear */
...
#define RTC_MODE0_INTFLAG_CMP_Msk   (__U(0x1) << RTC_MODE0_INTFLAG_CMP_Pos)
...
#define RTC_MODE0_INTFLAG_SYNCRDY   (__U(0x1) << RTC_MODE0_INTFLAG_SYNCRDY_Pos)
#define RTC_MODE0_INTFLAG_OVF_Pos   7            /**< \brief (RTC_MODE0_INTFLAG) Overflow */
#define RTC_MODE0_INTFLAG_OVF       (__U(0x1) << RTC_MODE0_INTFLAG_OVF_Pos)
#define RTC_MODE0_INTFLAG_MASK      __U(0xC1)     /**< \brief (RTC_MODE0_INTFLAG) MASK Register */
...
#define RTC_MODE1_INTFLAG_RESETVALUE __U(0x00)     /**< \brief (RTC_MODE1_INTFLAG reset_value) MODE1 Interrupt Flag Status and Clear */
...
#define RTC_MODE1_INTFLAG_CMP_Msk   (__U(0x3) << RTC_MODE1_INTFLAG_CMP_Pos)
...
#define RTC_MODE1_INTFLAG_SYNCRDY   (__U(0x1) << RTC_MODE1_INTFLAG_SYNCRDY_Pos)
#define RTC_MODE1_INTFLAG_OVF_Pos   7            /**< \brief (RTC_MODE1_INTFLAG) Overflow */
#define RTC_MODE1_INTFLAG_OVF       (__U(0x1) << RTC_MODE1_INTFLAG_OVF_Pos)
#define RTC_MODE1_INTFLAG_MASK      __U(0xC3)     /**< \brief (RTC_MODE1_INTFLAG) MASK Register */
...
#define RTC_MODE2_INTFLAG_RESETVALUE __U(0x00)     /**< \brief (RTC_MODE2_INTFLAG reset_value) MODE2 Interrupt Flag Status and Clear */
...
#define RTC_MODE2_INTFLAG_ALARM_Msk (__U(0x1) << RTC_MODE2_INTFLAG_ALARM_Pos)
...
#define RTC_MODE2_INTFLAG_SYNCRDY   (__U(0x1) << RTC_MODE2_INTFLAG_SYNCRDY_Pos)
#define RTC_MODE2_INTFLAG_OVF_Pos   7            /**< \brief (RTC_MODE2_INTFLAG) Overflow */
#define RTC_MODE2_INTFLAG_OVF       (__U(0x1) << RTC_MODE2_INTFLAG_OVF_Pos)
#define RTC_MODE2_INTFLAG_MASK      __U(0xC1)     /**< \brief (RTC_MODE2_INTFLAG) MASK Register */
...
#define RTC_STATUS_RESETVALUE       __U(0x00)     /**< \brief (RTC_STATUS reset_value) Status */

#define RTC_STATUS_SYNCBUSY_Pos     7            /**< \brief (RTC_STATUS) Synchronization Busy */
#define RTC_STATUS_SYNCBUSY         (__U(0x1) << RTC_STATUS_SYNCBUSY_Pos)
#define RTC_STATUS_MASK             __U(0x80)     /**< \brief (RTC_STATUS) MASK Register */
...
#define RTC_DBGCTRL_RESETVALUE      __U(0x00)     /**< \brief (RTC_DBGCTRL reset_value) Debug Control */

#define RTC_DBGCTRL_DBGRUN_Pos      0            /**< \brief (RTC_DBGCTRL) Run During Debug */
#define RTC_DBGCTRL_DBGRUN          (__U(0x1) << RTC_DBGCTRL_DBGRUN_Pos)
#define RTC_DBGCTRL_MASK            __U(0x01)     /**< \brief (RTC_DBGCTRL) MASK Register */
...
#define RTC_FREQCORR_RESETVALUE     __U(0x00)     /**< \brief (RTC_FREQCORR reset_value) Frequency Correction */

#define RTC_FREQCORR_VALUE_Pos      0            /**< \brief (RTC_FREQCORR) Correction Value */
#define RTC_FREQCORR_VALUE_Msk      (__U(0x7F) << RTC_FREQCORR_VALUE_Pos)
...
#define RTC_FREQCORR_SIGN           (__U(0x1) << RTC_FREQCORR_SIGN_Pos)
#define RTC_FREQCORR_MASK           __U(0xFF)     /**< \brief (RTC_FREQCORR) MASK Register */
...
#define RTC_MODE0_COUNT_RESETVALUE  __U(0x00000000) /**< \brief (RTC_MODE0_COUNT reset_value) MODE0 Counter Value */

#define RTC_MODE0_COUNT_COUNT_Pos   0            /**< \brief (RTC_MODE0_COUNT) Counter Value */
#define RTC_MODE0_COUNT_COUNT_Msk   (__U(0xFFFFFFFF) << RTC_MODE0_COUNT_COUNT_Pos)
#define RTC_MODE0_COUNT_COUNT(value) (RTC_MODE0_COUNT_COUNT_Msk & ((value) << RTC_MODE0_COUNT_COUNT_Pos))
#define RTC_MODE0_COUNT_MASK        __U(0xFFFFFFFF) /**< \brief (RTC_MODE0_COUNT) MASK Register */
...
#define RTC_MODE1_COUNT_RESETVALUE  __U(0x0000)   /**< \brief (RTC_MODE1_COUNT reset_value) MODE1 Counter Value */

#define RTC_MODE1_COUNT_COUNT_Pos   0            /**< \brief (RTC_MODE1_COUNT) Counter Value */
#define RTC_MODE1_COUNT_COUNT_Msk   (__U(0xFFFF) << RTC_MODE1_COUNT_COUNT_Pos)
#define RTC_MODE1_COUNT_COUNT(value) (RTC_MODE1_COUNT_COUNT_Msk & ((value) << RTC_MODE1_COUNT_COUNT_Pos))
#define RTC_MODE1_COUNT_MASK        __U(0xFFFF)   /**< \brief (RTC_MODE1_COUNT) MASK Register */
...
#define RTC_MODE2_CLOCK_RESETVALUE  __U(0x00000000) /**< \brief (RTC_MODE2_CLOCK reset_value) MODE2 Clock Value */

#define RTC_MODE2_CLOCK_SECOND_Pos  0            /**< \brief (RTC_MODE2_CLOCK) Second */
#define RTC_MODE2_CLOCK_SECOND_Msk  (__U(0x3F) << RTC_MODE2_CLOCK_SECOND_Pos)
...
#define RTC_MODE2_CLOCK_MINUTE_Msk  (__U(0x3F) << RTC_MODE2_CLOCK_MINUTE_Pos)
...
#define RTC_MODE2_CLOCK_HOUR_Msk    (__U(0x1F) << RTC_MODE2_CLOCK_HOUR_Pos)
#define RTC_MODE2_CLOCK_HOUR(value) (RTC_MODE2_CLOCK_HOUR_Msk & ((value) << RTC_MODE2_CLOCK_HOUR_Pos))
#define   RTC_MODE2_CLOCK_HOUR_AM_Val     __U(0x0)   /**< \brief (RTC_MODE2_CLOCK) AM when CLKREP in 12-hour */
#define   RTC_MODE2_CLOCK_HOUR_PM_Val     __U(0x10)   /**< \brief (RTC_MODE2_CLOCK) PM when CLKREP in 12-hour */
...
#define RTC_MODE2_CLOCK_DAY_Msk     (__U(0x1F) << RTC_MODE2_CLOCK_DAY_Pos)
...
#define RTC_MODE2_CLOCK_MONTH_Msk   (__U(0xF) << RTC_MODE2_CLOCK_MONTH_Pos)
...
#define RTC_MODE2_CLOCK_YEAR_Msk    (__U(0x3F) << RTC_MODE2_CLOCK_YEAR_Pos)
#define RTC_MODE2_CLOCK_YEAR(value) (RTC_MODE2_CLOCK_YEAR_Msk & ((value) << RTC_MODE2_CLOCK_YEAR_Pos))
#define RTC_MODE2_CLOCK_MASK        __U(0xFFFFFFFF) /**< \brief (RTC_MODE2_CLOCK) MASK Register */
...
#define RTC_MODE1_PER_RESETVALUE    __U(0x0000)   /**< \brief (RTC_MODE1_PER reset_value) MODE1 Counter Period */

#define RTC_MODE1_PER_PER_Pos       0            /**< \brief (RTC_MODE1_PER) Counter Period */
#define RTC_MODE1_PER_PER_Msk       (__U(0xFFFF) << RTC_MODE1_PER_PER_Pos)
#define RTC_MODE1_PER_PER(value)    (RTC_MODE1_PER_PER_Msk & ((value) << RTC_MODE1_PER_PER_Pos))
#define RTC_MODE1_PER_MASK          __U(0xFFFF)   /**< \brief (RTC_MODE1_PER) MASK Register */
...
#define RTC_MODE0_COMP_RESETVALUE   __U(0x00000000) /**< \brief (RTC_MODE0_COMP reset_value) MODE0 Compare n Value */

#define RTC_MODE0_COMP_COMP_Pos     0            /**< \brief (RTC_MODE0_COMP) Compare Value */
#define RTC_MODE0_COMP_COMP_Msk     (__U(0xFFFFFFFF) << RTC_MODE0_COMP_COMP_Pos)
#define RTC_MODE0_COMP_COMP(value)  (RTC_MODE0_COMP_COMP_Msk & ((value) << RTC_MODE0_COMP_COMP_Pos))
#define RTC_MODE0_COMP_MASK         __U(0xFFFFFFFF) /**< \brief (RTC_MODE0_COMP) MASK Register */
...
#define RTC_MODE1_COMP_RESETVALUE   __U(0x0000)   /**< \brief (RTC_MODE1_COMP reset_value) MODE1 Compare n Value */

#define RTC_MODE1_COMP_COMP_Pos     0            /**< \brief (RTC_MODE1_COMP) Compare Value */
#define RTC_MODE1_COMP_COMP_Msk     (__U(0xFFFF) << RTC_MODE1_COMP_COMP_Pos)
#define RTC_MODE1_COMP_COMP(value)  (RTC_MODE1_COMP_COMP_Msk & ((value) << RTC_MODE1_COMP_COMP_Pos))
#define RTC_MODE1_COMP_MASK         __U(0xFFFF)   /**< \brief (RTC_MODE1_COMP) MASK Register */
...
#define RTC_MODE2_ALARM_RESETVALUE  __U(0x00000000) /**< \brief (RTC_MODE2_ALARM reset_value) MODE2_ALARM Alarm n Value */

#define RTC_MODE2_ALARM_SECOND_Pos  0            /**< \brief (RTC_MODE2_ALARM) Second */
#define RTC_MODE2_ALARM_SECOND_Msk  (__U(0x3F) << RTC_MODE2_ALARM_SECOND_Pos)
...
#define RTC_MODE2_ALARM_MINUTE_Msk  (__U(0x3F) << RTC_MODE2_ALARM_MINUTE_Pos)
...
#define RTC_MODE2_ALARM_HOUR_Msk    (__U(0x1F) << RTC_MODE2_ALARM_HOUR_Pos)
#define RTC_MODE2_ALARM_HOUR(value) (RTC_MODE2_ALARM_HOUR_Msk & ((value) << RTC_MODE2_ALARM_HOUR_Pos))
#define   RTC_MODE2_ALARM_HOUR_AM_Val     __U(0x0)   /**< \brief (RTC_MODE2_ALARM) Morning hour */
#define   RTC_MODE2_ALARM_HOUR_PM_Val     __U(0x10)   /**< \brief (RTC_MODE2_ALARM) Afternoon hour */
...
#define RTC_MODE2_ALARM_DAY_Msk     (__U(0x1F) << RTC_MODE2_ALARM_DAY_Pos)
...
#define RTC_MODE2_ALARM_MONTH_Msk   (__U(0xF) << RTC_MODE2_ALARM_MONTH_Pos)
...
#define RTC_MODE2_ALARM_YEAR_Msk    (__U(0x3F) << RTC_MODE2_ALARM_YEAR_Pos)
#define RTC_MODE2_ALARM_YEAR(value) (RTC_MODE2_ALARM_YEAR_Msk & ((value) << RTC_MODE2_ALARM_YEAR_Pos))
#define RTC_MODE2_ALARM_MASK        __U(0xFFFFFFFF) /**< \brief (RTC_MODE2_ALARM) MASK Register */
...
#define RTC_MODE2_MASK_RESETVALUE   __U(0x00)     /**< \brief (RTC_MODE2_MASK reset_value) MODE2_ALARM Alarm n Mask */

#define RTC_MODE2_MASK_SEL_Pos      0            /**< \brief (RTC_MODE2_MASK) Alarm Mask Selection */
#define RTC_MODE2_MASK_SEL_Msk      (__U(0x7) << RTC_MODE2_MASK_SEL_Pos)
#define RTC_MODE2_MASK_SEL(value)   (RTC_MODE2_MASK_SEL_Msk & ((value) << RTC_MODE2_MASK_SEL_Pos))
#define   RTC_MODE2_MASK_SEL_OFF_Val      __U(0x0)   /**< \brief (RTC_MODE2_MASK) Alarm Disabled */
#define   RTC_MODE2_MASK_SEL_SS_Val       __U(0x1)   /**< \brief (RTC_MODE2_MASK) Match seconds only */
#define   RTC_MODE2_MASK_SEL_MMSS_Val     __U(0x2)   /**< \brief (RTC_MODE2_MASK) Match seconds and minutes only */
#define   RTC_MODE2_MASK_SEL_HHMMSS_Val   __U(0x3)   /**< \brief (RTC_MODE2_MASK) Match seconds, minutes, and hours only */
#define   RTC_MODE2_MASK_SEL_DDHHMMSS_Val __U(0x4)   /**< \brief (RTC_MODE2_MASK) Match seconds, minutes, hours, and days only */
#define   RTC_MODE2_MASK_SEL_MMDDHHMMSS_Val __U(0x5)   /**< \brief (RTC_MODE2_MASK) Match seconds, minutes, hours, days, and months only */
#define   RTC_MODE2_MASK_SEL_YYMMDDHHMMSS_Val __U(0x6)   /**< \brief (RTC_MODE2_MASK) Match seconds, minutes, hours, days, months, and years */
...
#define RTC_MODE2_MASK_MASK         __U(0x07)     /**< \brief (RTC_MODE2_MASK) MASK Register */
