...
#define AC_CTRLA_RESETVALUE         __U(0x00)     /**< \brief (AC_CTRLA reset_value) Control A */

#define AC_CTRLA_SWRST_Pos          0            /**< \brief (AC_CTRLA) Software Reset */
#define AC_CTRLA_SWRST              (__U(0x1) << AC_CTRLA_SWRST_Pos)
#define AC_CTRLA_ENABLE_Pos         1            /**< \brief (AC_CTRLA) Enable */
#define AC_CTRLA_ENABLE             (__U(0x1) << AC_CTRLA_ENABLE_Pos)
#define AC_CTRLA_RUNSTDBY_Pos       2            /**< \brief (AC_CTRLA) Run in Standby */
#define AC_CTRLA_RUNSTDBY_Msk       (__U(0x1) << AC_CTRLA_RUNSTDBY_Pos)
...
#define AC_CTRLA_LPMUX              (__U(0x1) << AC_CTRLA_LPMUX_Pos)
#define AC_CTRLA_MASK               __U(0x87)     /**< \brief (AC_CTRLA) MASK Register */
...
#define AC_CTRLB_RESETVALUE         __U(0x00)     /**< \brief (AC_CTRLB reset_value) Control B */
...
#define AC_CTRLB_START_Msk          (__U(0x3) << AC_CTRLB_START_Pos)
#define AC_CTRLB_START(value)       (AC_CTRLB_START_Msk & ((value) << AC_CTRLB_START_Pos))
#define AC_CTRLB_MASK               __U(0x03)     /**< \brief (AC_CTRLB) MASK Register */
...
#define AC_EVCTRL_RESETVALUE        __U(0x0000)   /**< \brief (AC_EVCTRL reset_value) Event Control */
...
#define AC_EVCTRL_COMPEO_Msk        (__U(0x3) << AC_EVCTRL_COMPEO_Pos)
...
#define AC_EVCTRL_WINEO_Msk         (__U(0x1) << AC_EVCTRL_WINEO_Pos)
...
#define AC_EVCTRL_COMPEI_Msk        (__U(0x3) << AC_EVCTRL_COMPEI_Pos)
#define AC_EVCTRL_COMPEI(value)     (AC_EVCTRL_COMPEI_Msk & ((value) << AC_EVCTRL_COMPEI_Pos))
#define AC_EVCTRL_MASK              __U(0x0313)   /**< \brief (AC_EVCTRL) MASK Register */
...
#define AC_INTENCLR_RESETVALUE      __U(0x00)     /**< \brief (AC_INTENCLR reset_value) Interrupt Enable Clear */
...
#define AC_INTENCLR_COMP_Msk        (__U(0x3) << AC_INTENCLR_COMP_Pos)
...
#define AC_INTENCLR_WIN_Msk         (__U(0x1) << AC_INTENCLR_WIN_Pos)
#define AC_INTENCLR_WIN(value)      (AC_INTENCLR_WIN_Msk & ((value) << AC_INTENCLR_WIN_Pos))
#define AC_INTENCLR_MASK            __U(0x13)     /**< \brief (AC_INTENCLR) MASK Register */
...
#define AC_INTENSET_RESETVALUE      __U(0x00)     /**< \brief (AC_INTENSET reset_value) Interrupt Enable Set */
...
#define AC_INTENSET_COMP_Msk        (__U(0x3) << AC_INTENSET_COMP_Pos)
...
#define AC_INTENSET_WIN_Msk         (__U(0x1) << AC_INTENSET_WIN_Pos)
#define AC_INTENSET_WIN(value)      (AC_INTENSET_WIN_Msk & ((value) << AC_INTENSET_WIN_Pos))
#define AC_INTENSET_MASK            __U(0x13)     /**< \brief (AC_INTENSET) MASK Register */
...
#define AC_INTFLAG_RESETVALUE       __U(0x00)     /**< \brief (AC_INTFLAG reset_value) Interrupt Flag Status and Clear */
...
#define AC_INTFLAG_COMP_Msk         (__U(0x3) << AC_INTFLAG_COMP_Pos)
...
#define AC_INTFLAG_WIN_Msk          (__U(0x1) << AC_INTFLAG_WIN_Pos)
#define AC_INTFLAG_WIN(value)       (AC_INTFLAG_WIN_Msk & ((value) << AC_INTFLAG_WIN_Pos))
#define AC_INTFLAG_MASK             __U(0x13)     /**< \brief (AC_INTFLAG) MASK Register */
...
#define AC_STATUSA_RESETVALUE       __U(0x00)     /**< \brief (AC_STATUSA reset_value) Status A */
...
#define AC_STATUSA_STATE_Msk        (__U(0x3) << AC_STATUSA_STATE_Pos)
#define AC_STATUSA_STATE(value)     (AC_STATUSA_STATE_Msk & ((value) << AC_STATUSA_STATE_Pos))
#define AC_STATUSA_WSTATE0_Pos      4            /**< \brief (AC_STATUSA) Window 0 Current State */
#define AC_STATUSA_WSTATE0_Msk      (__U(0x3) << AC_STATUSA_WSTATE0_Pos)
#define AC_STATUSA_WSTATE0(value)   (AC_STATUSA_WSTATE0_Msk & ((value) << AC_STATUSA_WSTATE0_Pos))
#define   AC_STATUSA_WSTATE0_ABOVE_Val    __U(0x0)   /**< \brief (AC_STATUSA) Signal is above window */
#define   AC_STATUSA_WSTATE0_INSIDE_Val   __U(0x1)   /**< \brief (AC_STATUSA) Signal is inside window */
#define   AC_STATUSA_WSTATE0_BELOW_Val    __U(0x2)   /**< \brief (AC_STATUSA) Signal is below window */
...
#define AC_STATUSA_MASK             __U(0x33)     /**< \brief (AC_STATUSA) MASK Register */
...
#define AC_STATUSB_RESETVALUE       __U(0x00)     /**< \brief (AC_STATUSB reset_value) Status B */
...
#define AC_STATUSB_READY_Msk        (__U(0x3) << AC_STATUSB_READY_Pos)
#define AC_STATUSB_READY(value)     (AC_STATUSB_READY_Msk & ((value) << AC_STATUSB_READY_Pos))
#define AC_STATUSB_SYNCBUSY_Pos     7            /**< \brief (AC_STATUSB) Synchronization Busy */
#define AC_STATUSB_SYNCBUSY         (__U(0x1) << AC_STATUSB_SYNCBUSY_Pos)
#define AC_STATUSB_MASK             __U(0x83)     /**< \brief (AC_STATUSB) MASK Register */
...
#define AC_STATUSC_RESETVALUE       __U(0x00)     /**< \brief (AC_STATUSC reset_value) Status C */
...
#define AC_STATUSC_STATE_Msk        (__U(0x3) << AC_STATUSC_STATE_Pos)
...
#define AC_STATUSC_WSTATE0_Msk      (__U(0x3) << AC_STATUSC_WSTATE0_Pos)
#define AC_STATUSC_WSTATE0(value)   (AC_STATUSC_WSTATE0_Msk & ((value) << AC_STATUSC_WSTATE0_Pos))
#define   AC_STATUSC_WSTATE0_ABOVE_Val    __U(0x0)   /**< \brief (AC_STATUSC) Signal is above window */
#define   AC_STATUSC_WSTATE0_INSIDE_Val   __U(0x1)   /**< \brief (AC_STATUSC) Signal is inside window */
#define   AC_STATUSC_WSTATE0_BELOW_Val    __U(0x2)   /**< \brief (AC_STATUSC) Signal is below window */
...
#define AC_STATUSC_MASK             __U(0x33)     /**< \brief (AC_STATUSC) MASK Register */
...
#define AC_WINCTRL_RESETVALUE       __U(0x00)     /**< \brief (AC_WINCTRL reset_value) Window Control */

#define AC_WINCTRL_WEN0_Pos         0            /**< \brief (AC_WINCTRL) Window 0 Mode Enable */
#define AC_WINCTRL_WEN0             (__U(0x1) << AC_WINCTRL_WEN0_Pos)
#define AC_WINCTRL_WINTSEL0_Pos     1            /**< \brief (AC_WINCTRL) Window 0 Interrupt Selection */
#define AC_WINCTRL_WINTSEL0_Msk     (__U(0x3) << AC_WINCTRL_WINTSEL0_Pos)
#define AC_WINCTRL_WINTSEL0(value)  (AC_WINCTRL_WINTSEL0_Msk & ((value) << AC_WINCTRL_WINTSEL0_Pos))
#define   AC_WINCTRL_WINTSEL0_ABOVE_Val   __U(0x0)   /**< \brief (AC_WINCTRL) Interrupt on signal above window */
#define   AC_WINCTRL_WINTSEL0_INSIDE_Val  __U(0x1)   /**< \brief (AC_WINCTRL) Interrupt on signal inside window */
#define   AC_WINCTRL_WINTSEL0_BELOW_Val   __U(0x2)   /**< \brief (AC_WINCTRL) Interrupt on signal below window */
#define   AC_WINCTRL_WINTSEL0_OUTSIDE_Val __U(0x3)   /**< \brief (AC_WINCTRL) Interrupt on signal outside window */
...
#define AC_WINCTRL_MASK             __U(0x07)     /**< \brief (AC_WINCTRL) MASK Register */
...
#define AC_COMPCTRL_RESETVALUE      __U(0x00000000) /**< \brief (AC_COMPCTRL reset_value) Comparator Control n */

#define AC_COMPCTRL_ENABLE_Pos      0            /**< \brief (AC_COMPCTRL) Enable */
#define AC_COMPCTRL_ENABLE          (__U(0x1) << AC_COMPCTRL_ENABLE_Pos)
#define AC_COMPCTRL_SINGLE_Pos      1            /**< \brief (AC_COMPCTRL) Single-Shot Mode */
#define AC_COMPCTRL_SINGLE          (__U(0x1) << AC_COMPCTRL_SINGLE_Pos)
#define AC_COMPCTRL_SPEED_Pos       2            /**< \brief (AC_COMPCTRL) Speed Selection */
#define AC_COMPCTRL_SPEED_Msk       (__U(0x3) << AC_COMPCTRL_SPEED_Pos)
#define AC_COMPCTRL_SPEED(value)    (AC_COMPCTRL_SPEED_Msk & ((value) << AC_COMPCTRL_SPEED_Pos))
#define   AC_COMPCTRL_SPEED_LOW_Val       __U(0x0)   /**< \brief (AC_COMPCTRL) Low speed */
#define   AC_COMPCTRL_SPEED_HIGH_Val      __U(0x1)   /**< \brief (AC_COMPCTRL) High speed */
...
#define AC_COMPCTRL_INTSEL_Msk      (__U(0x3) << AC_COMPCTRL_INTSEL_Pos)
#define AC_COMPCTRL_INTSEL(value)   (AC_COMPCTRL_INTSEL_Msk & ((value) << AC_COMPCTRL_INTSEL_Pos))
#define   AC_COMPCTRL_INTSEL_TOGGLE_Val   __U(0x0)   /**< \brief (AC_COMPCTRL) Interrupt on comparator output toggle */
#define   AC_COMPCTRL_INTSEL_RISING_Val   __U(0x1)   /**< \brief (AC_COMPCTRL) Interrupt on comparator output rising */
#define   AC_COMPCTRL_INTSEL_FALLING_Val  __U(0x2)   /**< \brief (AC_COMPCTRL) Interrupt on comparator output falling */
#define   AC_COMPCTRL_INTSEL_EOC_Val      __U(0x3)   /**< \brief (AC_COMPCTRL) Interrupt on end of comparison (single-shot mode only) */
...
#define AC_COMPCTRL_MUXNEG_Msk      (__U(0x7) << AC_COMPCTRL_MUXNEG_Pos)
#define AC_COMPCTRL_MUXNEG(value)   (AC_COMPCTRL_MUXNEG_Msk & ((value) << AC_COMPCTRL_MUXNEG_Pos))
#define   AC_COMPCTRL_MUXNEG_PIN0_Val     __U(0x0)   /**< \brief (AC_COMPCTRL) I/O pin 0 */
#define   AC_COMPCTRL_MUXNEG_PIN1_Val     __U(0x1)   /**< \brief (AC_COMPCTRL) I/O pin 1 */
#define   AC_COMPCTRL_MUXNEG_PIN2_Val     __U(0x2)   /**< \brief (AC_COMPCTRL) I/O pin 2 */
#define   AC_COMPCTRL_MUXNEG_PIN3_Val     __U(0x3)   /**< \brief (AC_COMPCTRL) I/O pin 3 */
#define   AC_COMPCTRL_MUXNEG_GND_Val      __U(0x4)   /**< \brief (AC_COMPCTRL) Ground */
#define   AC_COMPCTRL_MUXNEG_VSCALE_Val   __U(0x5)   /**< \brief (AC_COMPCTRL) VDD scaler */
#define   AC_COMPCTRL_MUXNEG_BANDGAP_Val  __U(0x6)   /**< \brief (AC_COMPCTRL) Internal bandgap voltage */
#define   AC_COMPCTRL_MUXNEG_DAC_Val      __U(0x7)   /**< \brief (AC_COMPCTRL) DAC output */
...
#define AC_COMPCTRL_MUXPOS_Msk      (__U(0x3) << AC_COMPCTRL_MUXPOS_Pos)
#define AC_COMPCTRL_MUXPOS(value)   (AC_COMPCTRL_MUXPOS_Msk & ((value) << AC_COMPCTRL_MUXPOS_Pos))
#define   AC_COMPCTRL_MUXPOS_PIN0_Val     __U(0x0)   /**< \brief (AC_COMPCTRL) I/O pin 0 */
#define   AC_COMPCTRL_MUXPOS_PIN1_Val     __U(0x1)   /**< \brief (AC_COMPCTRL) I/O pin 1 */
#define   AC_COMPCTRL_MUXPOS_PIN2_Val     __U(0x2)   /**< \brief (AC_COMPCTRL) I/O pin 2 */
#define   AC_COMPCTRL_MUXPOS_PIN3_Val     __U(0x3)   /**< \brief (AC_COMPCTRL) I/O pin 3 */
...
#define AC_COMPCTRL_SWAP            (__U(0x1) << AC_COMPCTRL_SWAP_Pos)
#define AC_COMPCTRL_OUT_Pos         16           /**< \brief (AC_COMPCTRL) Output */
#define AC_COMPCTRL_OUT_Msk         (__U(0x3) << AC_COMPCTRL_OUT_Pos)
#define AC_COMPCTRL_OUT(value)      (AC_COMPCTRL_OUT_Msk & ((value) << AC_COMPCTRL_OUT_Pos))
#define   AC_COMPCTRL_OUT_OFF_Val         __U(0x0)   /**< \brief (AC_COMPCTRL) The output of COMPn is not routed to the COMPn I/O port */
#define   AC_COMPCTRL_OUT_ASYNC_Val       __U(0x1)   /**< \brief (AC_COMPCTRL) The asynchronous output of COMPn is routed to the COMPn I/O port */
#define   AC_COMPCTRL_OUT_SYNC_Val        __U(0x2)   /**< \brief (AC_COMPCTRL) The synchronous output (including filtering) of COMPn is routed to the COMPn I/O port */
...
#define AC_COMPCTRL_HYST            (__U(0x1) << AC_COMPCTRL_HYST_Pos)
#define AC_COMPCTRL_FLEN_Pos        24           /**< \brief (AC_COMPCTRL) Filter Length */
#define AC_COMPCTRL_FLEN_Msk        (__U(0x7) << AC_COMPCTRL_FLEN_Pos)
#define AC_COMPCTRL_FLEN(value)     (AC_COMPCTRL_FLEN_Msk & ((value) << AC_COMPCTRL_FLEN_Pos))
#define   AC_COMPCTRL_FLEN_OFF_Val        __U(0x0)   /**< \brief (AC_COMPCTRL) No filtering */
#define   AC_COMPCTRL_FLEN_MAJ3_Val       __U(0x1)   /**< \brief (AC_COMPCTRL) 3-bit majority function (2 of 3) */
#define   AC_COMPCTRL_FLEN_MAJ5_Val       __U(0x2)   /**< \brief (AC_COMPCTRL) 5-bit majority function (3 of 5) */
...
#define AC_COMPCTRL_MASK            __U(0x070BB76F) /**< \brief (AC_COMPCTRL) MASK Register */
...
#define AC_SCALER_RESETVALUE        __U(0x00)     /**< \brief (AC_SCALER reset_value) Scaler n */

#define AC_SCALER_VALUE_Pos         0            /**< \brief (AC_SCALER) Scaler Value */
#define AC_SCALER_VALUE_Msk         (__U(0x3F) << AC_SCALER_VALUE_Pos)
#define AC_SCALER_VALUE(value)      (AC_SCALER_VALUE_Msk & ((value) << AC_SCALER_VALUE_Pos))
#define AC_SCALER_MASK              __U(0x3F)     /**< \brief (AC_SCALER) MASK Register */
