...
#define MTB_POSITION_WRAP           (__U(0x1) << MTB_POSITION_WRAP_Pos)
#define MTB_POSITION_POINTER_Pos    3            /**< \brief (MTB_POSITION) Trace Packet Location Pointer */
#define MTB_POSITION_POINTER_Msk    (__U(0x1FFFFFFF) << MTB_POSITION_POINTER_Pos)
#define MTB_POSITION_POINTER(value) (MTB_POSITION_POINTER_Msk & ((value) << MTB_POSITION_POINTER_Pos))
#define MTB_POSITION_MASK           __U(0xFFFFFFFC) /**< \brief (MTB_POSITION) MASK Register */
...
#define MTB_MASTER_RESETVALUE       __U(0x00000000) /**< \brief (MTB_MASTER reset_value) MTB Master */

#define MTB_MASTER_MASK_Pos         0            /**< \brief (MTB_MASTER) Maximum Value of the Trace Buffer in SRAM */
#define MTB_MASTER_MASK_Msk         (__U(0x1F) << MTB_MASTER_MASK_Pos)
...
#define MTB_MASTER_TSTARTEN         (__U(0x1) << MTB_MASTER_TSTARTEN_Pos)
#define MTB_MASTER_TSTOPEN_Pos      6            /**< \brief (MTB_MASTER) Trace Stop Input Enable */
#define MTB_MASTER_TSTOPEN          (__U(0x1) << MTB_MASTER_TSTOPEN_Pos)
#define MTB_MASTER_SFRWPRIV_Pos     7            /**< \brief (MTB_MASTER) Special Function Register Write Privilege */
#define MTB_MASTER_SFRWPRIV         (__U(0x1) << MTB_MASTER_SFRWPRIV_Pos)
#define MTB_MASTER_RAMPRIV_Pos      8            /**< \brief (MTB_MASTER) SRAM Privilege */
#define MTB_MASTER_RAMPRIV          (__U(0x1) << MTB_MASTER_RAMPRIV_Pos)
#define MTB_MASTER_HALTREQ_Pos      9            /**< \brief (MTB_MASTER) Halt Request */
#define MTB_MASTER_HALTREQ          (__U(0x1) << MTB_MASTER_HALTREQ_Pos)
#define MTB_MASTER_EN_Pos           31           /**< \brief (MTB_MASTER) Main Trace Enable */
#define MTB_MASTER_EN               (__U(0x1) << MTB_MASTER_EN_Pos)
#define MTB_MASTER_MASK_            __U(0x800003FF) /**< \brief (MTB_MASTER) MASK Register */
...
#define MTB_FLOW_RESETVALUE         __U(0x00000000) /**< \brief (MTB_FLOW reset_value) MTB Flow */

#define MTB_FLOW_AUTOSTOP_Pos       0            /**< \brief (MTB_FLOW) Auto Stop Tracing */
#define MTB_FLOW_AUTOSTOP           (__U(0x1) << MTB_FLOW_AUTOSTOP_Pos)
#define MTB_FLOW_AUTOHALT_Pos       1            /**< \brief (MTB_FLOW) Auto Halt Request */
#define MTB_FLOW_AUTOHALT           (__U(0x1) << MTB_FLOW_AUTOHALT_Pos)
#define MTB_FLOW_WATERMARK_Pos      3            /**< \brief (MTB_FLOW) Watermark value */
#define MTB_FLOW_WATERMARK_Msk      (__U(0x1FFFFFFF) << MTB_FLOW_WATERMARK_Pos)
#define MTB_FLOW_WATERMARK(value)   (MTB_FLOW_WATERMARK_Msk & ((value) << MTB_FLOW_WATERMARK_Pos))
#define MTB_FLOW_MASK               __U(0xFFFFFFFB) /**< \brief (MTB_FLOW) MASK Register */
...
#define MTB_BASE_MASK               __U(0xFFFFFFFF) /**< \brief (MTB_BASE) MASK Register */
...
#define MTB_ITCTRL_MASK             __U(0xFFFFFFFF) /**< \brief (MTB_ITCTRL) MASK Register */
...
#define MTB_CLAIMSET_MASK           __U(0xFFFFFFFF) /**< \brief (MTB_CLAIMSET) MASK Register */
...
#define MTB_CLAIMCLR_MASK           __U(0xFFFFFFFF) /**< \brief (MTB_CLAIMCLR) MASK Register */
...
#define MTB_LOCKACCESS_MASK         __U(0xFFFFFFFF) /**< \brief (MTB_LOCKACCESS) MASK Register */
...
#define MTB_LOCKSTATUS_MASK         __U(0xFFFFFFFF) /**< \brief (MTB_LOCKSTATUS) MASK Register */
...
#define MTB_AUTHSTATUS_MASK         __U(0xFFFFFFFF) /**< \brief (MTB_AUTHSTATUS) MASK Register */
...
#define MTB_DEVARCH_MASK            __U(0xFFFFFFFF) /**< \brief (MTB_DEVARCH) MASK Register */
...
#define MTB_DEVID_MASK              __U(0xFFFFFFFF) /**< \brief (MTB_DEVID) MASK Register */
...
#define MTB_DEVTYPE_MASK            __U(0xFFFFFFFF) /**< \brief (MTB_DEVTYPE) MASK Register */
...
#define MTB_PID4_MASK               __U(0xFFFFFFFF) /**< \brief (MTB_PID4) MASK Register */
...
#define MTB_PID5_MASK               __U(0xFFFFFFFF) /**< \brief (MTB_PID5) MASK Register */
...
#define MTB_PID6_MASK               __U(0xFFFFFFFF) /**< \brief (MTB_PID6) MASK Register */
...
#define MTB_PID7_MASK               __U(0xFFFFFFFF) /**< \brief (MTB_PID7) MASK Register */
...
#define MTB_PID0_MASK               __U(0xFFFFFFFF) /**< \brief (MTB_PID0) MASK Register */
...
#define MTB_PID1_MASK               __U(0xFFFFFFFF) /**< \brief (MTB_PID1) MASK Register */
...
#define MTB_PID2_MASK               __U(0xFFFFFFFF) /**< \brief (MTB_PID2) MASK Register */
...
#define MTB_PID3_MASK               __U(0xFFFFFFFF) /**< \brief (MTB_PID3) MASK Register */
...
#define MTB_CID0_MASK               __U(0xFFFFFFFF) /**< \brief (MTB_CID0) MASK Register */
...
#define MTB_CID1_MASK               __U(0xFFFFFFFF) /**< \brief (MTB_CID1) MASK Register */
...
#define MTB_CID2_MASK               __U(0xFFFFFFFF) /**< \brief (MTB_CID2) MASK Register */
...
#define MTB_CID3_MASK               __U(0xFFFFFFFF) /**< \brief (MTB_CID3) MASK Register */
