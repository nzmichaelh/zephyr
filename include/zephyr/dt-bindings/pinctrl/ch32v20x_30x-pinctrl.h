...
#define USART4_TX_PC10_0  CH32V20X_V30X_PINMUX_DEFINE(PC, 10, USART4, 0)
#define USART4_TX_PB0_1   CH32V20X_V30X_PINMUX_DEFINE(PB, 0, USART4, 1)
#define USART4_TX_PE0_2   CH32V20X_V30X_PINMUX_DEFINE(PE, 0, USART4, 2)
#define USART4_RX_PC11_0  CH32V20X_V30X_PINMUX_DEFINE(PC, 11, USART4, 0)
#define USART4_RX_PB1_1   CH32V20X_V30X_PINMUX_DEFINE(PB, 1, USART4, 1)
#define USART4_RX_PE1_2   CH32V20X_V30X_PINMUX_DEFINE(PE, 1, USART4, 2)
...
#define I2S3_WS_PA15_0 CH32V20X_V30X_PINMUX_DEFINE(PA, 15, I2S3, 0)
#define I2S3_WS_PA4_1  CH32V20X_V30X_PINMUX_DEFINE(PA, 4, I2S3, 1)
#define I2S3_CK_PB3_0  CH32V20X_V30X_PINMUX_DEFINE(PB, 3, I2S3, 0)
#define I2S3_CK_PC10_1 CH32V20X_V30X_PINMUX_DEFINE(PC, 10, I2S3, 1)
#define I2S3_MCK_PC7_0 CH32V20X_V30X_PINMUX_DEFINE(PC, 7, I2S3, 0)
#define I2S3_MCK_PC7_1 CH32V20X_V30X_PINMUX_DEFINE(PC, 7, I2S3, 1)
#define I2S3_SD_PB5_0  CH32V20X_V30X_PINMUX_DEFINE(PB, 5, I2S3, 0)
#define I2S3_SD_PC12_1 CH32V20X_V30X_PINMUX_DEFINE(PC, 12, I2S3, 1)
...
#define CAN1_RX_PA11_0 CH32V20X_V30X_PINMUX_DEFINE(PA, 11, CAN1, 0)
#define CAN1_RX_PB8_1  CH32V20X_V30X_PINMUX_DEFINE(PB, 8, CAN1, 1)
#define CAN1_RX_PD0_2  CH32V20X_V30X_PINMUX_DEFINE(PD, 0, CAN1, 2)
#define CAN1_TX_PA12_0 CH32V20X_V30X_PINMUX_DEFINE(PA, 12, CAN1, 0)
#define CAN1_TX_PB9_1  CH32V20X_V30X_PINMUX_DEFINE(PB, 9, CAN1, 1)
#define CAN1_TX_PD1_2  CH32V20X_V30X_PINMUX_DEFINE(PD, 1, CAN1, 2)

#define CAN2_RX_PB12_0 CH32V20X_V30X_PINMUX_DEFINE(PB, 12, CAN2, 0)
#define CAN2_RX_PB5_1  CH32V20X_V30X_PINMUX_DEFINE(PB, 5, CAN2, 1)
#define CAN2_TX_PB13_0 CH32V20X_V30X_PINMUX_DEFINE(PB, 13, CAN2, 0)
#define CAN2_TX_PB6_1  CH32V20X_V30X_PINMUX_DEFINE(PB, 6, CAN2, 1)
